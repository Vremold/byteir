...
// CHECK-NEXT:     %2 = "mhlo.custom_call"(%1) {api_version = 1 : i32, backend_config = "", byteir_attrs = {axis = 3 : i64, keep_dims = false, select_last_index = false}, call_target_name = "byteir.arg_max", called_computations = [], has_side_effect = false} : (tensor<10x10xf32>) -> tensor<10xf32>
