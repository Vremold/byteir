...
module {
  func.func @invalid_reshape(%arg0 : memref<2x3xf32, offset: 0, strides: [3, 1]>) -> memref<6xf32> {
...
module {
  func.func @invalid_slice(%arg0: memref<2x3xf32, offset: 0, strides: [3, 1]>) -> memref<1x3xf32> {
