...
func @mhlo_tuple_return(%arg0 : tensor<4xf32>, %arg1 : tensor<4xf32>) -> tuple<tensor<4xf32>, tensor<4xf32>> {
...
// CHECK-LABEL: func @mhlo_tuple_return

func @mhlo_mutiple_return_case_1(%arg0 : tensor<4xf32>, %arg1 : tensor<4xf32>) -> (tensor<4xf32>, tensor<4xf32>) {
  %0 = "mhlo.add"(%arg0, %arg1) : (tensor<4xf32>, tensor<4xf32>) -> tensor<4xf32>
  %1 = "mhlo.add"(%arg0, %arg1) : (tensor<4xf32>, tensor<4xf32>) -> tensor<4xf32>
  return %0, %1 : tensor<4xf32>, tensor<4xf32>
}
// CHECK-LABEL: func @mhlo_mutiple_return_case_1

func @mhlo_mutiple_return_case_2(%arg0 : tensor<4xf32>, %arg1 : tensor<4xf32>) -> (tensor<4xf32>, tensor<4xf32>) {
  %0 = "mhlo.add"(%arg0, %arg1) : (tensor<4xf32>, tensor<4xf32>) -> tensor<4xf32>
  %1 = "mhlo.add"(%arg0, %arg1) : (tensor<4xf32>, tensor<4xf32>) -> tensor<4xf32>
...
// CHECK-LABEL: func @mhlo_mutiple_return_case_2
