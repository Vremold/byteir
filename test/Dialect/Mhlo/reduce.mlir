...
func @reduce_multiple_operand(%arg0: tensor<4x12x240x240xf32>, %arg1: tensor<4x12x240x240xi32>, %arg2: tensor<f32>, %arg3: tensor<i32>) -> (tensor<4x12x240xf32>, tensor<4x12x240xi32>) {
  %0:2 = mhlo.reduce(%arg0 init: %arg2), (%arg1 init: %arg3) across dimensions = [3] : (tensor<4x12x240x240xf32>, tensor<4x12x240x240xi32>, tensor<f32>, tensor<i32>) -> (tensor<4x12x240xf32>, tensor<4x12x240xi32>)
    ...
    %1 = "mhlo.compare"(%arg4, %arg6) {comparison_direction = "GE"} : (tensor<f32>, tensor<f32>) -> tensor<i1>
    %2 = "mhlo.select"(%1, %arg4, %arg6) : (tensor<i1>, tensor<f32>, tensor<f32>) -> tensor<f32>
    %3 = "mhlo.compare"(%arg4, %arg6) {comparison_direction = "EQ"} : (tensor<f32>, tensor<f32>) -> tensor<i1>
