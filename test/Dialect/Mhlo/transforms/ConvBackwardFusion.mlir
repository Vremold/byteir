...
// CHECK-LABEL: func @conv_backward_data
// CHECK-NEXT:  mhlo.fusion
// CHECK-NEXT:    mhlo.transpose
// CHECK-NEXT:    mhlo.reverse
// CHECK-NEXT:    mhlo.convolution
// CHECK-NEXT:    mhlo.return
// CHECK-NEXT:  {{.*}}__byre__batch_group_count = 1 : i64, __byre__feature_group_count = 1 : i64, __byre__input_layout = "NCHW", __byre__kernel_layout = "NCHW", __byre__output_layout = "NCHW", __byre__padding = dense<1> : tensor<2xi64>, __byre__window_strides = dense<1> : tensor<2xi64>, byre_compute_name = "ConvBackwardDataOp"

func @conv_backward_filter(%58: tensor<32x64x56x56xf16>, %408: tensor<32x64x56x56xf16>) -> tensor<64x64x3x3xf16> {
...
// CHECK-LABEL: func @conv_backward_filter
// CHECK-NEXT:  mhlo.fusion
// CHECK-NEXT:    mhlo.convolution
// CHECK-NEXT:    mhlo.transpose
// CHECK-NEXT:    mhlo.return
// CHECK-NEXT:  {{.*}}__byre__batch_group_count = 1 : i64, __byre__feature_group_count = 1 : i64, __byre__input_layout = "NCHW", __byre__kernel_layout = "NCHW", __byre__output_layout = "NCHW", __byre__padding = dense<1> : tensor<2xi64>, __byre__window_strides = dense<1> : tensor<2xi64>, byre_compute_name = "ConvBackwardFilterOp"

func @conv_backward_override(%157: tensor<32x256x14x14xf16>, %173: tensor<512x256x1x1xf16>, %256: tensor<32x512x7x7xf16>) -> (tensor<32x256x14x14xf16>, tensor<512x256x1x1xf16>) {
...
// CHECK-LABEL: func @conv_backward_override
// CHECK-NEXT:  mhlo.fusion
// CHECK-NEXT:    mhlo.transpose
// CHECK-NEXT:    mhlo.convolution
// CHECK-NEXT:    mhlo.return
// CHECK-NEXT:  {{.*}}__byre__batch_group_count = 1 : i64, __byre__feature_group_count = 1 : i64, __byre__input_layout = "NCHW", __byre__kernel_layout = "NCHW", __byre__output_layout = "NCHW", __byre__padding = dense<0> : tensor<2xi64>, __byre__window_strides = dense<2> : tensor<2xi64>, byre_compute_name = "ConvBackwardDataOp"
// CHECK-NEXT:  mhlo.fusion
// CHECK-NEXT:    mhlo.convolution
// CHECK-NEXT:    mhlo.transpose
// CHECK-NEXT:    mhlo.return
// CHECK-NEXT:  {{.*}}__byre__batch_group_count = 1 : i64, __byre__feature_group_count = 1 : i64, __byre__input_layout = "NCHW", __byre__kernel_layout = "NCHW", __byre__output_layout = "NCHW", __byre__padding = dense<0> : tensor<2xi64>, __byre__window_strides = dense<2> : tensor<2xi64>, byre_compute_name = "ConvBackwardFilterOp"