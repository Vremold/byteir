...
// CHECK-NEXT:  {{.*}}batch_group_count = 1 : i64, byre_compute_name = "ConvBackwardDataOp", feature_group_count = 1 : i64, input_layout = "NCHW", kernel_layout = "NCHW", output_layout = "NCHW", padding = dense<1> : tensor<2xi64>, window_strides = dense<1> : tensor<2xi64>
...
// CHECK-NEXT:    mhlo.transpose
// CHECK-NEXT:    mhlo.return
// CHECK-NEXT:  {{.*}}batch_group_count = 1 : i64, byre_compute_name = "ConvBackwardFilterOp", feature_group_count = 1 : i64, input_layout = "NCHW", kernel_layout = "NCHW", output_layout = "NCHW", padding = dense<1> : tensor<2xi64>, window_strides = dense<1> : tensor<2xi64>
...
// CHECK-NEXT:    mhlo.convolution
// CHECK-NEXT:    mhlo.return
// CHECK-NEXT:  {{.*}}batch_group_count = 1 : i64, byre_compute_name = "ConvBackwardDataOp", feature_group_count = 1 : i64, input_layout = "NCHW", kernel_layout = "NCHW", output_layout = "NCHW", padding = dense<0> : tensor<2xi64>, window_strides = dense<2> : tensor<2xi64>
// CHECK-NEXT:  mhlo.fusion
// CHECK-NEXT:    mhlo.convolution
// CHECK-NEXT:    mhlo.transpose
// CHECK-NEXT:    mhlo.return
// CHECK-NEXT:  {{.*}}batch_group_count = 1 : i64, byre_compute_name = "ConvBackwardFilterOp", feature_group_count = 1 : i64, input_layout = "NCHW", kernel_layout = "NCHW", output_layout = "NCHW", padding = dense<0> : tensor<2xi64>, window_strides = dense<2> : tensor<2xi64>