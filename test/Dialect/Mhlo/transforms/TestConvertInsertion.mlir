...
func private @test_func(%arg0: tensor<4x?xf32>, %arg1: tensor<4x?xf32>, %arg2: tensor<4x?xi64>) -> tensor<2x128x128xf32> attributes {__byteir_unit_test__}
// CHECK-LABEL: func private @test_func
// CHECK-SAME: (tensor<4x?xf16>, tensor<4x?xf16>, tensor<4x?xi64>) -> tensor<2x128x128xf16>

func @main1(%arg0: tensor<4x?xf32>, %arg1: tensor<4x?xf32>, %arg2: tensor<4x?xi64>) -> tensor<2x128x128xf32> {
...
func @main2(%arg0: tensor<4x?xf32>, %arg1: tensor<4x?xi64>) -> tensor<2x128x128xf32> {
