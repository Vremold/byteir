...
func @batch_norm_training_grad_fp16(%arg0: tensor<32x256x14x14xf16>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<32x256x14x14xf16>, %arg4: tensor<256xf32>) -> (tensor<32x256x14x14xf16>, tensor<32x256x14x14xf16>) {
...
func @batch_norm_training_grad(%arg0: tensor<32x256x14x14xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<32x256x14x14xf32>) -> (tensor<32x256x14x14xf32>, tensor<32x256x14x14xf32>) {
...
// CHECK-LABEL: func @batch_norm_grad_fp16
// CHECK-NEXT:  mhlo.fusion
// CHECK-NEXT:    mhlo.convert
// CHECK-NEXT:    mhlo.convert
// CHECK-NEXT:    mhlo.batch_norm_grad
...
func @batch_norm_grad(%arg0: tensor<32x256x14x14xf32>, %arg1: tensor<32x256x14x14xf32>, %arg2: tensor<256xf32>, %arg3: tensor<256xf32>, %7: tensor<256xf32>) -> (tensor<32x256x14x14xf32>, tensor<256xf32>, tensor<256xf32>) {
