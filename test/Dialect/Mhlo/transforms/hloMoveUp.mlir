...
func @transpose_move_up_unary(%arg0: tensor<31x20x32xf32>) -> tensor<20x31x32xf32> {
...
// CHECK-LABEL: func @transpose_move_up_unary
// CHECK-NEXT: mhlo.transpose
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: return

func @reshape_move_up_convert(%arg0: tensor<1x32xi32>) -> tensor<1x32x32xf32> {
...
// CHECK-LABEL: func @reshape_move_up_convert
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.convert
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

func @transpose_unary_side_user(%arg0: tensor<31x20x32xf32>) -> (tensor<20x31x32xf32>, tensor<31x20x32xf32>) {
    %0 = "mhlo.abs"(%arg0) : (tensor<31x20x32xf32>) -> tensor<31x20x32xf32>
    %1 = "mhlo.transpose"(%0) {permutation = dense<[1, 0, 2]> : tensor<3xi64>} : (tensor<31x20x32xf32>) -> tensor<20x31x32xf32>
    %2 = "mhlo.abs"(%0) : (tensor<31x20x32xf32>) -> tensor<31x20x32xf32>
    return %1, %2 : tensor<20x31x32xf32>, tensor<31x20x32xf32>
}
// CHECK-LABEL: func @transpose_unary_side_user
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.transpose
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: return

func @transpose_move_up_unary_and_cancel(%arg0 : tensor<31x20x32xf32>) -> tensor<31x20x32xf32> {
...
// CHECK-LABEL: func @transpose_move_up_unary_and_cancel
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: return

func @transpose_move_up_unary_many_and_cancel(%arg0 : tensor<31x20x32xf32>) -> tensor<31x20x32xf32> {
    %0 = "mhlo.transpose"(%arg0) {permutation = dense<[1, 0, 2]> : tensor<3xi64>} : (tensor<31x20x32xf32>) -> tensor<20x31x32xf32>
    %1 = "mhlo.abs"(%0) : (tensor<20x31x32xf32>) -> tensor<20x31x32xf32>
...
// CHECK-LABEL: func @transpose_move_up_unary_many_and_cancel
// CHECK-NEXT: mhlo.abs
...
func @transpose_binary_splat_const(%arg0 : tensor<31x20x32xf32>) -> tensor<20x31x32xf32> {
...
// CHECK-LABEL: func @transpose_binary_splat_const
// CHECK-NEXT: mhlo.constant
// CHECK-NEXT: mhlo.transpose
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: return

func @transpose_move_up_binary(%arg0 : tensor<31x20x32xf32>, %arg1 : tensor<31x20x32xf32>) -> tensor<20x31x32xf32> {
    %0 = mhlo.add %arg0, %arg1 : tensor<31x20x32xf32>
    %1 = "mhlo.transpose"(%0) {permutation = dense<[1, 0, 2]> : tensor<3xi64>} : (tensor<31x20x32xf32>) -> tensor<20x31x32xf32>
    return %1 : tensor<20x31x32xf32>
}
// CHECK-LABEL: func @transpose_move_up_binary
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: mhlo.transpose
// CHECK-NEXT: return

// MULTIINPUT-LABEL: func @transpose_move_up_binary
// MULTIINPUT-NEXT: mhlo.transpose
// MULTIINPUT-NEXT: mhlo.transpose
// MULTIINPUT-NEXT: mhlo.add
// MULTIINPUT-NEXT: return

func @transpose_move_up_binary_cancel(%arg0 : tensor<20x31x32xf32>, %arg1 : tensor<20x31x32xf32>) -> tensor<20x31x32xf32> {
...
// CHECK-LABEL: func @transpose_move_up_binary_cancel
// CHECK-NEXT: mhlo.transpose
// CHECK-NEXT: mhlo.transpose
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: mhlo.transpose
...
// MULTIINPUT-LABEL: func @transpose_move_up_binary_cancel
// MULTIINPUT-NEXT: mhlo.add
// MULTIINPUT-NEXT: return

func @transpose_move_up_binary_same(%arg0 : tensor<31x20x32xf32>) -> tensor<20x31x32xf32> {
    %0 = mhlo.add %arg0, %arg0 : tensor<31x20x32xf32>
    %1 = "mhlo.transpose"(%0) {permutation = dense<[1, 0, 2]> : tensor<3xi64>} : (tensor<31x20x32xf32>) -> tensor<20x31x32xf32>
    return %1 : tensor<20x31x32xf32>
}
// CHECK-LABEL: func @transpose_move_up_binary_same
// CHECK-NEXT: mhlo.transpose
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: return

// MULTIINPUT-LABEL: func @transpose_move_up_binary_same
// MULTIINPUT-NEXT: mhlo.transpose
// MULTIINPUT-NEXT: mhlo.add
// MULTIINPUT-NEXT: return

func @reshape_move_up_unary(%arg0: tensor<31x20x32xf32>) -> tensor<31x640xf32> {
    %0 = "mhlo.abs"(%arg0) : (tensor<31x20x32xf32>) -> tensor<31x20x32xf32>
    %1 = "mhlo.reshape"(%0) : (tensor<31x20x32xf32>) -> tensor<31x640xf32>
    return %1 : tensor<31x640xf32>
}
// CHECK-LABEL: func @reshape_move_up_unary
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: return

func @reshape_unary_side_user(%arg0: tensor<31x20x32xf32>) -> (tensor<31x640xf32>, tensor<31x20x32xf32>) {
    %0 = "mhlo.abs"(%arg0) : (tensor<31x20x32xf32>) -> tensor<31x20x32xf32>
    %1 = "mhlo.reshape"(%0) : (tensor<31x20x32xf32>) -> tensor<31x640xf32>
    %2 = "mhlo.abs"(%0) : (tensor<31x20x32xf32>) -> tensor<31x20x32xf32>
    return %1, %2 : tensor<31x640xf32>, tensor<31x20x32xf32>
}
// CHECK-LABEL: func @reshape_unary_side_user
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: return

func @reshape_move_up_unary_and_cancel(%arg0 : tensor<31x20x32xf32>) -> tensor<31x20x32xf32> {
...
// CHECK-LABEL: func @reshape_move_up_unary_and_cancel
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: return

func @reshape_move_up_unary_many_and_cancel(%arg0 : tensor<31x20x32xf32>) -> tensor<31x20x32xf32> {
...
// CHECK-LABEL: func @reshape_move_up_unary_many_and_cancel
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.sine
// CHECK-NEXT: mhlo.sine
// CHECK-NEXT: mhlo.sine
...
func @reshape_binary_splat_const(%arg0 : tensor<31x20x32xf32>) -> tensor<20x31x32xf32> {
    %0 = mhlo.constant dense<1.000000e+00> : tensor<31x20x32xf32>
    %1 = mhlo.add %arg0, %0 : tensor<31x20x32xf32>
    %2 = "mhlo.reshape"(%1) : (tensor<31x20x32xf32>) -> tensor<20x31x32xf32>
    return %2 : tensor<20x31x32xf32>
}
// CHECK-LABEL: func @reshape_binary_splat_const
// CHECK-NEXT: mhlo.constant
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: return

func @reshape_move_up_binary(%arg0 : tensor<31x20x32xf32>, %arg1 : tensor<31x20x32xf32>) -> tensor<20x31x32xf32> {
    %0 = mhlo.add %arg0, %arg1 : tensor<31x20x32xf32>
    %1 = "mhlo.reshape"(%0) : (tensor<31x20x32xf32>) -> tensor<20x31x32xf32>
    return %1 : tensor<20x31x32xf32>
}
// CHECK-LABEL: func @reshape_move_up_binary
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: return

// MULTIINPUT-LABEL: func @reshape_move_up_binary
// MULTIINPUT-NEXT: mhlo.reshape
// MULTIINPUT-NEXT: mhlo.reshape
// MULTIINPUT-NEXT: mhlo.add
// MULTIINPUT-NEXT: return

func @reshape_move_up_binary_cancel(%arg0 : tensor<20x31x32xf32>, %arg1 : tensor<20x31x32xf32>) -> tensor<20x31x32xf32> {
...
// CHECK-LABEL: func @reshape_move_up_binary_cancel
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: mhlo.reshape
...
// MULTIINPUT-LABEL: func @reshape_move_up_binary_cancel
// MULTIINPUT-NEXT: mhlo.add
// MULTIINPUT-NEXT: return

func @reshape_move_up_binary_same(%arg0 : tensor<31x20x32xf32>) -> tensor<20x31x32xf32> {
    %0 = mhlo.add %arg0, %arg0 : tensor<31x20x32xf32>
    %1 = "mhlo.reshape"(%0) : (tensor<31x20x32xf32>) -> tensor<20x31x32xf32>
    return %1 : tensor<20x31x32xf32>
}
// CHECK-LABEL: func @reshape_move_up_binary_same
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: return

// MULTIINPUT-LABEL: func @reshape_move_up_binary_same
// MULTIINPUT-NEXT: mhlo.reshape
// MULTIINPUT-NEXT: mhlo.add
// MULTIINPUT-NEXT: return
