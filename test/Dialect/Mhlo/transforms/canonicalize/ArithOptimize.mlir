...
func @add_zero_right(%arg0: tensor<128xf32>) -> tensor<128xf32> {
  %c0 = mhlo.constant dense<0.000000e+00> : tensor<128xf32>
...
func @mul_one_left(%arg0: tensor<128xf32>) -> tensor<128xf32> {
...
func @mul_one_right(%arg0: tensor<128xf32>) -> tensor<128xf32> {
  %c1 = mhlo.constant dense<1.000000e+00> : tensor<128xf32>
