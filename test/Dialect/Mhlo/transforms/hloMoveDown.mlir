...
func @broadcast_move_down_unary(%arg0 : tensor<32xf32>) -> tensor<4x32xf32> {
...
// CHECK-LABEL: func @broadcast_move_down_unary
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

func @broadcast_move_down_convert(%arg0 : tensor<32xi32>) -> tensor<4x32xf32> {
...
// CHECK-LABEL: func @broadcast_move_down_convert
// CHECK-NEXT: mhlo.convert
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

func @broadcast_binary_same(%arg0 : tensor<32xf32>) -> tensor<4x32xf32> {
    %0 = "mhlo.broadcast_in_dim"(%arg0) {broadcast_dimensions = dense<1> : tensor<1xi64>} : (tensor<32xf32>) -> tensor<4x32xf32>
    %1 = mhlo.add %0, %0 : tensor<4x32xf32>
    return %1 : tensor<4x32xf32>
}
// CHECK-LABEL: func @broadcast_binary_same
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

 func @broadcast_move_down_binary_splat_const(%arg0 : tensor<32xf32>) -> tensor<4x32xf32> {
 ...
 // CHECK-LABEL: func @broadcast_move_down_binary_splat_const
 // CHECK-NEXT: mhlo.constant
 // CHECK-NEXT: mhlo.add
 // CHECK-NEXT: mhlo.broadcast
 // CHECK-NEXT: return

func @broadcast_move_down_unary_and_merge(%arg0 : tensor<32xf32>) -> tensor<8x4x32xf32> {
    %0 = "mhlo.broadcast_in_dim"(%arg0) {broadcast_dimensions = dense<1> : tensor<1xi64>} : (tensor<32xf32>) -> tensor<4x32xf32>
    %1 = "mhlo.abs"(%0) : (tensor<4x32xf32>) -> tensor<4x32xf32>
...
// CHECK-LABEL: func @broadcast_move_down_unary_and_merge
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

func @broadcast_move_down_unary_many_and_merge(%arg0 : tensor<32xf32>) -> tensor<8x4x32xf32> {
    %0 = "mhlo.broadcast_in_dim"(%arg0) {broadcast_dimensions = dense<1> : tensor<1xi64>} : (tensor<32xf32>) -> tensor<4x32xf32>
    %1 = "mhlo.abs"(%0) : (tensor<4x32xf32>) -> tensor<4x32xf32>
...
// CHECK-LABEL: func @broadcast_move_down_unary_many_and_merge
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.sine
// CHECK-NEXT: mhlo.sine
// CHECK-NEXT: mhlo.sine
...
func @broadcast_parallel_to_binary(%arg0 : tensor<32xf32>, %arg1 : tensor<32xf32>) -> tensor<4x32xf32> {
    %0 = "mhlo.broadcast_in_dim"(%arg0) {broadcast_dimensions = dense<1> : tensor<1xi64>} : (tensor<32xf32>) -> tensor<4x32xf32>
...
// CHECK-LABEL: func @broadcast_parallel_to_binary
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

func @broadcast_parallel_to_binary_with_unary(%arg0 : tensor<32xf32>, %arg1 : tensor<32xf32>) -> tensor<4x32xf32> {
    %0 = "mhlo.broadcast_in_dim"(%arg0) {broadcast_dimensions = dense<1> : tensor<1xi64>} : (tensor<32xf32>) -> tensor<4x32xf32>
    %1 = "mhlo.abs"(%0) : (tensor<4x32xf32>) -> tensor<4x32xf32>
...
// CHECK-LABEL: func @broadcast_parallel_to_binary_with_unary
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.abs
// CHECK-NEXT: mhlo.add
// CHECK-NEXT: mhlo.broadcast_in_dim
...
func @broadcast_reshape(%arg0 : tensor<1x64xf16>) -> tensor<1024x64xf16> {
...
// CHECK-LABEL: func @broadcast_reshape
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

func @broadcast_reshape_dot(%arg0 : tensor<1x64xf16>, %arg1 : tensor<64x176xf16>) -> tensor<1024x176xf16> {
    %0 = "mhlo.broadcast_in_dim" (%arg0) {broadcast_dimensions = dense<[0, 2]> : tensor<2xi64>} : (tensor<1x64xf16>) -> tensor<1x1024x64xf16>
    %1 = "mhlo.reshape"(%0) : (tensor<1x1024x64xf16>) -> tensor<1024x64xf16>
...
// CHECK-LABEL: func @broadcast_reshape_dot
// CHECK-NEXT: mhlo.dot
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.broadcast_in_dim
// CHECK-NEXT: return

func @broadcast_reshape_dot_with_concat(%arg0 : tensor<1x64xf16>, %arg1: tensor<1024x176xf16>, %arg2 : tensor<64x176xf16>) -> (tensor<1024x240xf16>, tensor<1024x176xf16>) {
    %0 = "mhlo.broadcast_in_dim" (%arg0) {broadcast_dimensions = dense<[0, 2]> : tensor<2xi64>} : (tensor<1x64xf16>) -> tensor<1x1024x64xf16>
    %1 = "mhlo.reshape"(%0) : (tensor<1x1024x64xf16>) -> tensor<1024x64xf16>
...
// CHECK-LABEL: func @broadcast_reshape_dot_with_concat
// CHECK-NEXT: mhlo.reshape
// CHECK-NEXT: mhlo.broadcast_in_dim
...
func @broadcast_reshape_dot_with_concat_and_add(%arg0 : tensor<1x64xf16>, %arg1: tensor<1024x176xf16>, %arg2 : tensor<64x176xf16>, %arg3 : tensor<176xf16>) -> (tensor<1024x240xf16>, tensor<1024x176xf16>) {
    %0 = "mhlo.broadcast_in_dim" (%arg0) {broadcast_dimensions = dense<[0, 2]> : tensor<2xi64>} : (tensor<1x64xf16>) -> tensor<1x1024x64xf16>
    %1 = "mhlo.reshape"(%0) : (tensor<1x1024x64xf16>) -> tensor<1024x64xf16>
    %2 = "mhlo.concatenate"(%arg1, %1) {dimension = 1 : i64} : (tensor<1024x176xf16>, tensor<1024x64xf16>) -> tensor<1024x240xf16>
    %3 = "mhlo.dot"(%1, %arg2) : (tensor<1024x64xf16>, tensor<64x176xf16>) -> tensor<1024x176xf16>
