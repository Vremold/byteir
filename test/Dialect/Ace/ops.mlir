...
func @test_custom_call(%arg0 : tensor<5xf32>) -> tensor<5xf32> {
  %0 = "ace.custom_call"(%arg0) {call_target_name = "byteir.test"} : (tensor<5xf32>) -> tensor<5xf32>
  return %0 : tensor<5xf32>
}
// CHECK:  ace.custom_call

func @test_custom_call_multi_inputs_outputs(%arg0 : tensor<5xf32>, %arg1 : tensor<5xi32>) -> (tensor<5xf32>, tensor<5xi32>) {
...
func @test_custom_call_ace_type_string(%arg0 : tensor<!ace.string>) -> tensor<1x!ace.string> {
  %0 = "ace.custom_call"(%arg0) {call_target_name = "tf.Reshape"} : (tensor<!ace.string>) -> tensor<1x!ace.string>
  return %0 : tensor<1x!ace.string>
}
// CHECK: ace.custom_call

func @test_custom_call_ace_type_resource() -> tensor<!ace.resource> {
