...
// CHECK: %1 = memref.alloc(%0) : memref<100x?xf32, [[MAP_0]], 1>
  %2 = memref.load %arg0[%c0, %c0] : memref<100x?xf32>
  %3 = memref.load %1[%c1, %c0] : memref<100x?xf32, 1>
// CHECK: memref.load %1[%c1, %c0] : memref<100x?xf32, [[MAP_0]], 1>
...
// CHECK: %1 = memref.alloc(%0) : memref<100x?xf32, [[MAP_1]], 1>
  %2 = memref.load %arg0[%c0, %c0] : memref<100x?xf32>
  %3 = memref.load %1[%c1, %c0] : memref<100x?xf32, 1>
// CHECK: memref.load %1[%c1, %c0] : memref<100x?xf32, [[MAP_1]], 1>
  %4 = arith.addf %2, %3 : f32
  memref.store %4, %arg1[%c0, %c1] : memref<100x?xf32>
  return
}
...
// CHECK: memref.alloc(%0) {layout = "other_layout"} : memref<100x?xf32, 1>
  %2 = memref.load %arg0[%c0, %c0] : memref<100x?xf32>
  %3 = memref.load %1[%c1, %c0] : memref<100x?xf32, 1>
  %4 = arith.addf %2, %3 : f32
  memref.store %4, %arg1[%c0, %c1] : memref<100x?xf32>
