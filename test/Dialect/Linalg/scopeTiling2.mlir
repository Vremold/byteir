...
func @matmul_element_static_complete_0(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
...
// CHECK-LABEL: func @matmul_element_static_complete_0(
...
// CHECK:   memref.subview %[[ARG0]][%[[ARG3]], 0] [%[[C2]], 64] [1, 1]
// CHECK:   linalg.matmul
...
func @matmul_element_static_complete_1(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
  %0 = memref.alloc() : memref<128x64xf32>
  %1 = memref.alloc() : memref<128x64xf32>
...
// CHECK-LABEL: func @matmul_element_static_complete_1(
// CHECK-SAME: %[[ARG0:.*]]: memref<128x64xf32>, %[[ARG1:.*]]: memref<64x64xf32>, %[[ARG2:.*]]: memref<128x64xf32>
// CHECK:   linalg.matmul
...
// CHECK:   memref.subview %[[ARG0]][0, %[[ARG3]]] [128, %[[C2]]] [1, 1]
// CHECK:   linalg.generic
// CHECK:   scf.yield
// CHECK: linalg.generic
// CHECK: linalg.generic

func @matmul_element_static_complete_2(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
  %0 = memref.alloc() : memref<128x64xf32>
  %1 = memref.alloc() : memref<128x64xf32>
...
// CHECK-LABEL: func @matmul_element_static_complete_2(
// CHECK-SAME: %[[ARG0:.*]]: memref<128x64xf32>, %[[ARG1:.*]]: memref<64x64xf32>, %[[ARG2:.*]]: memref<128x64xf32>
// CHECK-DAG: %[[C64:.*]] = arith.constant 64 : index
// CHECK-DAG: %[[C2:.*]] = arith.constant 2 : index
// CHECK-DAG: %[[C0:.*]] = arith.constant 0 : index
...
// CHECK:   memref.subview %[[ARG0]][0, %[[ARG3]]] [128, %[[C2]]] [1, 1]
// CHECK:   memref.subview %[[ARG1]][%[[ARG3]], 0] [%[[C2]], 64] [1, 1]
// CHECK:   linalg.matmul
// CHECK: linalg.generic
// CHECK: linalg.generic
// CHECK: linalg.generic
