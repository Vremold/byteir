// RUN: byteir-opt %s -linalg-scope-tile="anchor-tag=anchor axis=0 tile-size=2" -cse | FileCheck %s -check-prefix=AXIS0
// RUN: byteir-opt %s -linalg-scope-tile="anchor-tag=anchor axis=1 tile-size=2" -cse | FileCheck %s -check-prefix=AXIS1
// RUN: byteir-opt %s -linalg-scope-tile="anchor-tag=anchor axis=2 tile-size=2" -cse | FileCheck %s -check-prefix=AXIS2

#map0 = affine_map<(d0, d1) -> (d0, d1)>

func @matmul_element_static(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
  %0 = memref.alloc() : memref<128x64xf32>
  %1 = memref.alloc() : memref<128x64xf32>
  linalg.matmul {anchor} ins(%arg0, %arg1 : memref<128x64xf32>, memref<64x64xf32>) outs(%0 : memref<128x64xf32>)
...
// AXIS0-LABEL: func @matmul_element_static(
...
// AXIS0: scf.for %[[ARG3:.*]] = %[[C0]] to %[[C128]] step %[[C2]] {
// AXIS0: memref.subview %[[ARG0]][%[[ARG3]], 0] [%[[C2]], 64] [1, 1]
// AXIS0: linalg.matmul
// AXIS0: linalg.generic
// AXIS0: linalg.generic
// AXIS0: linalg.generic

// AXIS1-LABEL: func @matmul_element_static(
...
// AXIS1: scf.for %[[ARG3:.*]] = %[[C0]] to %[[C64]] step %[[C2]] {
// AXIS1: memref.subview %[[ARG1]][0, %[[ARG3]]] [64, %[[C2]]] [1, 1]
// AXIS1: linalg.matmul
// AXIS1: linalg.generic
// AXIS1: linalg.generic
// AXIS1: linalg.generic

// AXIS2-LABEL: func @matmul_element_static(
...
// AXIS2: memref.subview %[[ARG0]][0, %[[ARG3]]] [128, %[[C2]]] [1, 1]
// AXIS2: memref.subview %[[ARG1]][%[[ARG3]], 0] [%[[C2]], 64] [1, 1]
// AXIS2: linalg.matmul
