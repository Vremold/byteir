...
func @matmul_static(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
...
// CHECK-DAG: linalg.copy(%arg0, %[[V0]]) : memref<128x64xf32>, memref<128x64xf32, 1>
// CHECK-DAG: linalg.copy(%arg1, %[[V1]]) : memref<64x64xf32>, memref<64x64xf32, 2>
// CHECK: linalg.matmul ins(%[[V0]], %[[V1]] : memref<128x64xf32, 1>, memref<64x64xf32, 2>) outs(%[[V2]] : memref<128x64xf32, 3>)
// CHECK-DAG: linalg.copy(%[[V2]], %arg2) : memref<128x64xf32, 3>, memref<128x64xf32>
  return
}

// CHECK-LABEL: func @matmul_static_completed_tag
func @matmul_static_completed_tag(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
...
// CHECK-DAG: linalg.copy(%arg0, %[[V0]]) : memref<128x64xf32>, memref<128x64xf32, 4>
// CHECK-DAG: linalg.copy(%arg1, %[[V1]]) : memref<64x64xf32>, memref<64x64xf32, 5>
// CHECK: linalg.matmul ins(%[[V0]], %[[V1]] : memref<128x64xf32, 4>, memref<64x64xf32, 5>) outs(%[[V2]] : memref<128x64xf32, 6>)
// CHECK-DAG: linalg.copy(%[[V2]], %arg2) : memref<128x64xf32, 6>, memref<128x64xf32>
  return
}

// CHECK-LABEL: func @matmul_static_bad_tag
func @matmul_static_bad_tag(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
...
// CHECK-LABEL: func @matmul_static_partial_tag
func @matmul_static_partial_tag(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
...
func @matmul_dynamic(%arg0: memref<128x?xf32>, %arg1: memref<?x64xf32>, %arg2: memref<128x64xf32>) {
...
// CHECK-DAG: %[[V2:.*]] = memref.alloc() : memref<128x64xf32, 3>
// CHECK-DAG: linalg.copy(%arg0, %[[V0]]) : memref<128x?xf32>, memref<128x?xf32, 1>
// CHECK-DAG: linalg.copy(%arg1, %[[V1]]) : memref<?x64xf32>, memref<?x64xf32, 2>
...
func @matmul_tiled(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>) {
  ...
  scf.for %arg3 = %c0 to %c128 step %c8 {
    ...
    // CHECK-DAG: linalg.copy(%{{.*}}, %[[V0]]) : memref<?x64xf32, #map>, memref<?x64xf32, 1>
    // CHECK-DAG: linalg.copy(%arg1, %[[V1]]) : memref<64x64xf32>, memref<64x64xf32, 2>
    // CHECK: linalg.matmul ins(%[[V0]], %[[V1]] : memref<?x64xf32, 1>, memref<64x64xf32, 2>) outs(%[[V2]] : memref<?x64xf32, 3>)
    // CHECK-DAG: linalg.copy(%[[V2]], %{{.*}}) : memref<?x64xf32, 3>, memref<?x64xf32, #map>
  }
  return
}
