// RUN: byteir-opt %s -set-all-space="entry-func=main space=cpu" | FileCheck %s
...
// CHECK-NEXT:     "lmhlo.add"(%arg0, %arg1, %0) : (memref<2x4xf32, "cpu">, memref<2x4xf32, "cpu">, memref<2x4xf32, "cpu">) -> ()
