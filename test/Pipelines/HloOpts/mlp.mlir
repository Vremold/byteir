...
// CHECK: func private @Unknown
// CHECK:   mhlo.log
// CHECK: func @main
module @IrToMhlo.91 {
  func @main(%arg0: tensor<50xf32>, %arg1: tensor<50x784xf32>, %arg2: tensor<50xf32>, %arg3: tensor<50x50xf32>, %arg4: tensor<10xf32>, %arg5: tensor<10x50xf32>, %arg6: tensor<32x1x28x28xf32>) -> tuple<tensor<32x10xf32>, tensor<32x50xf32>, tensor<32x50xf32>> {
  ...
  func private @aten.view.20(%arg0: tensor<32x1x28x28xf32>) -> tensor<32x784xf32> {
    %0 = "mhlo.reshape"(%arg0) : (tensor<32x1x28x28xf32>) -> tensor<32x784xf32>
    return %0 : tensor<32x784xf32>
  }
  func private @aten.permute.16(%arg0: tensor<50x784xf32>) -> tensor<784x50xf32> {
  ...
  func private @aten.addmm.24(%arg0: tensor<32x784xf32>, %arg1: tensor<784x50xf32>, %arg2: tensor<50xf32>) -> tensor<32x50xf32> {
    %0 = "mhlo.dot"(%arg0, %arg1) {precision_config = ["DEFAULT", "DEFAULT"]} : (tensor<32x784xf32>, tensor<784x50xf32>) -> tensor<32x50xf32>
  ...
  func private @aten.relu.35(%arg0: tensor<32x50xf32>) -> tensor<32x50xf32> {
  ...
  func private @aten.permute.12(%arg0: tensor<50x50xf32>) -> tensor<50x50xf32> {
  ...
  func private @aten.addmm.41(%arg0: tensor<32x50xf32>, %arg1: tensor<50x50xf32>, %arg2: tensor<50xf32>) -> tensor<32x50xf32> {
    %0 = "mhlo.dot"(%arg0, %arg1) {precision_config = ["DEFAULT", "DEFAULT"]} : (tensor<32x50xf32>, tensor<50x50xf32>) -> tensor<32x50xf32>
    %1 = "mhlo.reshape"(%arg2) : (tensor<50xf32>) -> tensor<1x50xf32>
    %2 = "mhlo.broadcast_in_dim"(%1) {broadcast_dimensions = dense<[0, 1]> : tensor<2xi64>} : (tensor<1x50xf32>) -> tensor<1x50xf32>
    %3 = "mhlo.reshape"(%2) : (tensor<1x50xf32>) -> tensor<50xf32>
    %4 = "mhlo.broadcast_in_dim"(%3) {broadcast_dimensions = dense<1> : tensor<1xi64>} : (tensor<50xf32>) -> tensor<32x50xf32>
  ...
  func private @aten.relu.52(%arg0: tensor<32x50xf32>) -> tensor<32x50xf32> {
    %0 = mhlo.constant dense<0.000000e+00> : tensor<f32>
    %1 = "mhlo.broadcast_in_dim"(%0) {broadcast_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>) -> tensor<32x50xf32>
    %2 = mhlo.maximum %arg0, %1 : tensor<32x50xf32>
    return %2 : tensor<32x50xf32>
  }
  func private @aten.permute.8(%arg0: tensor<10x50xf32>) -> tensor<50x10xf32> {
  ...
  func private @aten.addmm.58(%arg0: tensor<32x50xf32>, %arg1: tensor<50x10xf32>, %arg2: tensor<10xf32>) -> tensor<32x10xf32> {
    %0 = "mhlo.dot"(%arg0, %arg1) {precision_config = ["DEFAULT", "DEFAULT"]} : (tensor<32x50xf32>, tensor<50x10xf32>) -> tensor<32x10xf32>
  ...
  func private @aten.log_softmax.77(%arg0: tensor<32x10xf32>) -> tensor<32x10xf32> {
