...
// CHECK-LABEL:  func @relu6(%arg0: tensor<4x4xf32>) -> tensor<4x4xf32> {
// CHECK-NEXT:    %0 = "ace.activate"(%arg0) {act_func = "relu6"} : (tensor<4x4xf32>) -> tensor<4x4xf32>
// CHECK-NEXT:    return %0 : tensor<4x4xf32>
// CHECK-NEXT:  }

func @leaky_relu(%arg0: tensor<4x4xf32>) -> tensor<4x4xf32> {
  ...
  %3 = "mhlo.compare"(%arg0, %1) {comparison_direction = "GT"} : (tensor<4x4xf32>, tensor<4x4xf32>) -> tensor<4x4xi1>
  %4 = "mhlo.select"(%3, %arg0, %2) : (tensor<4x4xi1>, tensor<4x4xf32>, tensor<4x4xf32>) -> tensor<4x4xf32>
  return %4 : tensor<4x4xf32>
}
// CHECK-LABEL: func @leaky_relu(%arg0: tensor<4x4xf32>) -> tensor<4x4xf32> {
