...
// CHECK-LABEL: loop1
func @loop1(%arg0: memref<16xf32>, %arg1: memref<16xf32>, %arg2: memref<f32>, %arg3: memref<16xf32>) -> memref<16xui32> attributes {byre_elementwise_fusion} {
  ...
  affine.for %arg4 = 0 to 16 {
    ...
    %9 = maxf %4, %5 : f32
    %10 = minf %9, %8 : f32
    %11 = fptosi %10 : f32 to i64
    %12 = trunci %11 : i64 to i32
    memref.store %12, %0[%arg4] : memref<16xi32>
  }
  %1 = memref.tensor_load %0 : memref<16xi32>
  %2 = builtin.unrealized_conversion_cast %1 : tensor<16xi32> to tensor<16xui32>
  %3 = memref.buffer_cast %2 : memref<16xui32>
...
// CHECK-LABEL: loop4
func @loop4(%arg0: memref<16x31x128xf32>, %arg1: memref<16x31x127x128xf32>) -> memref<16x31x127x128xi1> attributes {byre_elementwise_fusion} {
