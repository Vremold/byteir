...
// CHECK: module attributes {byre.container_module}  {
  func @mhlo_add(%arg0: memref<4xf32> {byre.argname = "A", byre.argtype = 1 : i32}, %arg1: memref<4xf32> {byre.argname = "B", byre.argtype = 1 : i32}, %arg2: memref<4xf32> {byre.argname = "C", byre.argtype = 2 : i32}) attributes { byre.entry_point } {
...
//   CHECK:  byre.compute @AddOp(%arg0, %arg1, %arg2) : memref<4xf32>, memref<4xf32>, memref<4xf32>
  func @lace_reshape(%arg0: memref<1x1024xi64> {byre.argname = "A", byre.argtype = 1 : i32}, %arg1: memref<32x32xi64> {byre.argname = "B", byre.argtype = 2 : i32}) attributes { byre.entry_point } {
...
// CHECK-LABEL: func @lace_reshape
//   CHECK:  byre.compute @AliasOp
//     CHECK-SAME: offset = 0
//   CHECK:  byre.compute @AddOp

 func @lace_slice(%arg0: memref<1x512xi64> {byre.argname = "A", byre.argtype = 1 : i32}, %arg1: memref<1x128xi64> {byre.argname = "B", byre.argtype = 2 : i32}) attributes { byre.entry_point } {
