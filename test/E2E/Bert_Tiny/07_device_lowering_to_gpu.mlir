...
module  {
  ...
  func private @Unknown7(%arg0: memref<256xi1>, %arg1: memref<2x128x128xf32>, %arg2: memref<256xi1>) -> (memref<256x128xf32>, memref<256x128xf32>) attributes {byre_elementwise_fusion} {
    ...
    affine.for %arg3 = 0 to 32768 {
      ...
      %9 = affine.load %5[%8, %7] : memref<2x128xi1>
      %10 = affine.load %arg1[%8, %7, %6] : memref<2x128x128xf32>
      %11 = select %9, %10, %cst : f32
      affine.store %11, %3[%8, %7, %6] : memref<2x128x128xf32>
      %12 = affine.load %2[%8, %7] : memref<2x128xi1>
      %13 = select %12, %10, %cst : f32
      affine.store %13, %0[%8, %7, %6] : memref<2x128x128xf32>
    }
