...
func private @Unknown0(%arg0: memref<32xf32>, %arg1: memref<128x32xf32>) -> memref<128x32xf32> attributes { byre_compute_name = "AddOp"}  {
...
func @mlp(%arg0: memref<128x64xf32> {__placeholder__byre.argname = "A"}, %arg1: memref<64x32xf32> {__placeholder__byre.argname = "B"}, %arg2: memref<32xf32> {__placeholder__byre.argname = "C"}) -> (memref<128x32xf32> {__placeholder__byre.argname = "D"}) attributes { __placeholder__byre.entry_point} {
  %0 = memref.alloc() : memref<128x32xf32>
