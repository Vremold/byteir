...
module {
  ...
  func private @Unknown0(%arg0: memref<2x128xi64>) -> (memref<256xi64>, memref<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %1 = memref.alloc() : memref<256xi1>
    linalg.generic {indexing_maps = [#map0, #map1], iterator_types = ["parallel", "parallel"]} ins(%arg0 : memref<2x128xi64>) outs(%1 : memref<256xi1>) {
  ...
  func private @Unknown1(%arg0: memref<2x128xi64>) -> (memref<256xui32>, memref<256x1xi64>, memref<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %0 = memref.alloc() : memref<256xui32>
    ...
    ^bb0(%arg1: i64, %arg2: i64):  // no predecessors
      ...
      %6 = select %5, %4, %arg1 : i64
      linalg.yield %6 : i64
    }
    %2 = memref.expand_shape %1 [[0, 1]] : memref<256xi64> into memref<256x1xi64>
    %3 = memref.alloc() : memref<256xi1>
    linalg.generic {indexing_maps = [#map0, #map1], iterator_types = ["parallel", "parallel"]} ins(%arg0 : memref<2x128xi64>) outs(%3 : memref<256xi1>) {
    ^bb0(%arg1: i64, %arg2: i1):  // no predecessors
      %4 = arith.sitofp %arg1 : i64 to f64
      %5 = arith.cmpf une, %4, %cst : f64
      linalg.yield %5 : i1
    }
    return %0, %2, %3 : memref<256xui32>, memref<256x1xi64>, memref<256xi1>
  }
  func private @Unknown2(%arg0: memref<128xi64>) -> (memref<256xui32>, memref<256x1xi64>, memref<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map2, #map0], iterator_types = ["parallel", "parallel"]} ins(%arg0 : memref<128xi64>) outs(%2 : memref<2x128xi64>) {
    ^bb0(%arg1: i64, %arg2: i64):  // no predecessors
    ...
    linalg.generic {indexing_maps = [#map2, #map0], iterator_types = ["parallel", "parallel"]} ins(%arg0 : memref<128xi64>) outs(%5 : memref<2x128xi1>) {
    ^bb0(%arg1: i64, %arg2: i1):  // no predecessors
  ...
  func private @Unknown5(%arg0: memref<256x30522xf32>, %arg1: memref<30522xf32>) -> (memref<2x128x30522xf32>, memref<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map4, #map7, #map6], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg0, %arg1 : memref<256x30522xf32>, memref<30522xf32>) outs(%1 : memref<2x128x30522xf32>) {
    ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):  // no predecessors
      %3 = arith.addf %arg2, %arg3 : f32
      linalg.yield %3 : f32
    }
    %2 = memref.alloc() : memref<256x30522xf32>
    linalg.generic {indexing_maps = [#map6, #map7, #map4], iterator_types = ["parallel", "parallel", "parallel"]} ins(%0, %arg1 : memref<2x128x30522xf32>, memref<30522xf32>) outs(%2 : memref<256x30522xf32>) {
    ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):  // no predecessors
      %3 = arith.addf %arg2, %arg3 : f32
      linalg.yield %3 : f32
    }
    return %1, %2 : memref<2x128x30522xf32>, memref<256x30522xf32>
  }
  ...
  func private @Unknown8(%arg0: memref<256xf32>, %arg1: memref<256x30522xf32>, %arg2: memref<256xi64>, %arg3: memref<256xi1>) -> (memref<256x30522xf32>, memref<256x30522xf32>, memref<256x30522xf32>, memref<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    ^bb0(%arg4: i1, %arg5: i64, %arg6: f32):  // no predecessors
      ...
      %7 = select %6, %cst, %cst_0 : f32
      %8 = select %arg4, %cst, %cst_0 : f32
  ...
  func private @Unknown12(%arg0: memref<256xf32>, %arg1: memref<256x30522xf32>, %arg2: memref<256x30522xf32>) -> (memref<256x30522xf32>, memref<2x128x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map4, #map4, #map11, #map6], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg2, %arg1, %1 : memref<256x30522xf32>, memref<256x30522xf32>, memref<2x128xf32>) outs(%2 : memref<2x128x30522xf32>) {
    ^bb0(%arg3: f32, %arg4: f32, %arg5: f32, %arg6: f32):  // no predecessors
      %3 = arith.mulf %arg4, %arg5 : f32
      %4 = arith.subf %arg3, %3 : f32
      linalg.yield %4 : f32
  ...
  func private @Unknown17(%arg0: memref<256xi1>, %arg1: memref<2x128x128xf32>, %arg2: memref<256xi1>) -> (memref<256x128xf32>, memref<256x128xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    %1 = memref.alloc() : memref<256x128xf32>
    linalg.generic {indexing_maps = [#map11, #map6, #map4], iterator_types = ["parallel", "parallel", "parallel"]} ins(%0, %arg1 : memref<2x128xi1>, memref<2x128x128xf32>) outs(%1 : memref<256x128xf32>) {
    ^bb0(%arg3: i1, %arg4: f32, %arg5: f32):  // no predecessors
      %4 = select %arg3, %arg4, %cst : f32
      linalg.yield %4 : f32
    }
    %2 = memref.expand_shape %arg2 [[0, 1]] : memref<256xi1> into memref<2x128xi1>
    %3 = memref.alloc() : memref<256x128xf32>
    linalg.generic {indexing_maps = [#map11, #map6, #map4], iterator_types = ["parallel", "parallel", "parallel"]} ins(%2, %arg1 : memref<2x128xi1>, memref<2x128x128xf32>) outs(%3 : memref<256x128xf32>) {
    ^bb0(%arg3: i1, %arg4: f32, %arg5: f32):  // no predecessors
      %4 = select %arg3, %arg4, %cst : f32
      linalg.yield %4 : f32
    }
    return %1, %3 : memref<256x128xf32>, memref<256x128xf32>
  }
  ...
  func @main(%arg0: memref<2x128xi64>, %arg1: memref<2x128xi64>, %arg2: memref<1x512xi64>, %arg3: memref<1x512xi64>, %arg4: memref<30522x128xf32>, %arg5: memref<2x128xf32>, %arg6: memref<512x128xf32>, %arg7: memref<128xf32>, %arg8: memref<128xf32>, %arg9: memref<128x128xf32>, %arg10: memref<128xf32>, %arg11: memref<128x128xf32>, %arg12: memref<128xf32>, %arg13: memref<128x128xf32>, %arg14: memref<128xf32>, %arg15: memref<128x128xf32>, %arg16: memref<128xf32>, %arg17: memref<128xf32>, %arg18: memref<128xf32>, %arg19: memref<512x128xf32>, %arg20: memref<512xf32>, %arg21: memref<128x512xf32>, %arg22: memref<128xf32>, %arg23: memref<128xf32>, %arg24: memref<128xf32>, %arg25: memref<128x128xf32>, %arg26: memref<128xf32>, %arg27: memref<128x128xf32>, %arg28: memref<128xf32>, %arg29: memref<128x128xf32>, %arg30: memref<128xf32>, %arg31: memref<128x128xf32>, %arg32: memref<128xf32>, %arg33: memref<128xf32>, %arg34: memref<128xf32>, %arg35: memref<512x128xf32>, %arg36: memref<512xf32>, %arg37: memref<128x512xf32>, %arg38: memref<128xf32>, %arg39: memref<128xf32>, %arg40: memref<128xf32>, %arg41: memref<128x128xf32>, %arg42: memref<128xf32>, %arg43: memref<128xf32>, %arg44: memref<128xf32>, %arg45: memref<30522xf32>) -> (memref<2x128x30522xf32>, memref<f32>, memref<30522x128xf32>, memref<2x128xf32>, memref<512x128xf32>, memref<128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128xf32>, memref<128xf32>, memref<512x128xf32>, memref<512xf32>, memref<128x512xf32>, memref<128xf32>, memref<128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128xf32>, memref<128xf32>, memref<512x128xf32>, memref<512xf32>, memref<128x512xf32>, memref<128xf32>, memref<128xf32>, memref<128xf32>, memref<128x128xf32>, memref<128xf32>, memref<128xf32>, memref<128xf32>, memref<30522xf32>) {
    ...
    %87 = call @MatmulOp0(%71, %86#0) : (memref<256x128xf32>, memref<256x30522xf32>) -> memref<30522x128xf32>
    ...
    %106 = call @Unknown13(%99, %103) : (memref<2x128x128xf32>, memref<2x128x128xf32>) -> memref<2x128x128xf32>
    ...
    %130 = call @Unknown14(%110, %121, %124, %127) : (memref<2x128x128xf32>, memref<2x128x128xf32>, memref<2x128x128xf32>, memref<2x128x128xf32>) -> memref<2x128x128xf32>
    ...
    %141 = call @Unknown15(%134, %138) : (memref<2x128x128xf32>, memref<2x128x128xf32>) -> memref<2x128x128xf32>
    ...
    %165 = call @Unknown16(%145, %156, %159, %162) : (memref<2x128x128xf32>, memref<2x128x128xf32>, memref<2x128x128xf32>, memref<2x128x128xf32>) -> memref<2x128x128xf32>
    ...
    %169:2 = call @Unknown17(%9#2, %166, %11#2) : (memref<256xi1>, memref<2x128x128xf32>, memref<256xi1>) -> (memref<256x128xf32>, memref<256x128xf32>)
    ...
    %173 = call @Unknown18(%13#2, %172) : (memref<128xi1>, memref<128x128xf32>) -> memref<128x128xf32>
