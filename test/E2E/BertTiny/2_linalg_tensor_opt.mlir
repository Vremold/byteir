...
module {
  func.func private @Unknown0(%arg0: tensor<2x128xi64>) -> (tensor<256xi64>, tensor<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %2 = "mhlo.compare"(%1, %0) {comparison_direction = #mhlo<comparison_direction NE>} : (tensor<256xi64>, tensor<256xi64>) -> tensor<256xi1>
  ...
  func.func private @Unknown1(%arg0: tensor<2x128xi64>) -> (tensor<256xui32>, tensor<256x1xi64>, tensor<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %5 = "mhlo.compare"(%3, %0) {comparison_direction = #mhlo<comparison_direction LT>} : (tensor<256xi64>, tensor<256xi64>) -> tensor<256xi1>
    ...
    %10 = "mhlo.compare"(%9, %1) {comparison_direction = #mhlo<comparison_direction NE>} : (tensor<256xf64>, tensor<256xf64>) -> tensor<256xi1>
  ...
  func.func private @Unknown2(%arg0: tensor<128xi64>) -> (tensor<256xui32>, tensor<256x1xi64>, tensor<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %6 = "mhlo.compare"(%4, %2) {comparison_direction = #mhlo<comparison_direction LT>} : (tensor<256xi64>, tensor<256xi64>) -> tensor<256xi1>
    ...
    %11 = "mhlo.compare"(%10, %0) {comparison_direction = #mhlo<comparison_direction NE>} : (tensor<256xf64>, tensor<256xf64>) -> tensor<256xi1>
  ...
  func.func private @Unknown3(%arg0: tensor<1x128xi64>) -> (tensor<128xui32>, tensor<128x1xi64>, tensor<128xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %5 = "mhlo.compare"(%3, %2) {comparison_direction = #mhlo<comparison_direction LT>} : (tensor<128xi64>, tensor<128xi64>) -> tensor<128xi1>
    ...
    %10 = "mhlo.compare"(%9, %0) {comparison_direction = #mhlo<comparison_direction NE>} : (tensor<128xf64>, tensor<128xf64>) -> tensor<128xi1>
  ...
  func.func private @Unknown8(%arg0: tensor<256xf32>, %arg1: tensor<256x30522xf32>, %arg2: tensor<256xi64>, %arg3: tensor<256xi1>) -> (tensor<256x30522xf32>, tensor<256x30522xf32>, tensor<256x30522xf32>, tensor<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    %7 = "mhlo.compare"(%4, %6) {comparison_direction = #mhlo<comparison_direction EQ>} : (tensor<256x30522xi64>, tensor<256x30522xi64>) -> tensor<256x30522xi1>
    %8 = "mhlo.select"(%7, %0, %1) : (tensor<256x30522xi1>, tensor<256x30522xf32>, tensor<256x30522xf32>) -> tensor<256x30522xf32>
    %9 = "mhlo.compare"(%8, %0) {comparison_direction = #mhlo<comparison_direction NE>} : (tensor<256x30522xf32>, tensor<256x30522xf32>) -> tensor<256x30522xi1>
    %10 = mhlo.negate %8 : tensor<256x30522xf32>
    %11 = mhlo.multiply %10, %3 : tensor<256x30522xf32>
    %12 = "mhlo.select"(%9, %1, %11) : (tensor<256x30522xi1>, tensor<256x30522xf32>, tensor<256x30522xf32>) -> tensor<256x30522xf32>
    %13 = "mhlo.broadcast_in_dim"(%arg3) {broadcast_dimensions = dense<0> : tensor<1xi64>} : (tensor<256xi1>) -> tensor<256x30522xi1>
    %14 = "mhlo.select"(%13, %0, %1) : (tensor<256x30522xi1>, tensor<256x30522xf32>, tensor<256x30522xf32>) -> tensor<256x30522xf32>
  ...
  func.func private @Unknown10(%arg0: tensor<f32>) -> tensor<f32> attributes {__byteir_elementwise_fusion__} {
    ...
    %2 = "mhlo.compare"(%arg0, %0) {comparison_direction = #mhlo<comparison_direction NE>} : (tensor<f32>, tensor<f32>) -> tensor<i1>
    %3 = "mhlo.select"(%2, %arg0, %1) : (tensor<i1>, tensor<f32>, tensor<f32>) -> tensor<f32>
    return %3 : tensor<f32>
  }
