...
module {
  func private @Unknown0(%arg0: memref<2x128xi64>) -> (memref<256xi64>, memref<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg1 = %c0 to %c256 step %c1 {
      ...
      %12 = memref.load %arg0[%11, %5] : memref<2x128xi64>
      %13 = arith.cmpi ne, %12, %c-100_i64 : i64
      memref.store %13, %0[%arg1] : memref<256xi1>
    }
  ...
  func private @Unknown1(%arg0: memref<2x128xi64>) -> (memref<256xui32>, memref<256x1xi64>, memref<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg1 = %c0 to %c256 step %c1 {
      %4 = arith.remsi %arg1, %c128 : index
      %5 = arith.cmpi slt, %4, %c0 : index
      %6 = arith.addi %4, %c128 : index
      %7 = arith.select %5, %6, %4 : index
      %8 = arith.cmpi slt, %arg1, %c0 : index
      %9 = arith.subi %c-1, %arg1 : index
      %10 = arith.select %8, %9, %arg1 : index
      %11 = arith.divsi %10, %c128 : index
      %12 = arith.subi %c-1, %11 : index
      %13 = arith.select %8, %12, %11 : index
      %14 = memref.load %arg0[%13, %7] : memref<2x128xi64>
      %15 = arith.trunci %14 : i64 to i32
      %16 = builtin.unrealized_conversion_cast %15 : i32 to ui32
      memref.store %16, %0[%arg1] : memref<256xui32>
    }
    scf.for %arg1 = %c0 to %c256 step %c1 {
      %4 = arith.remsi %arg1, %c128 : index
      %5 = arith.cmpi slt, %4, %c0 : index
      ...
      %13 = arith.select %8, %12, %11 : index
      %14 = memref.load %arg0[%13, %7] : memref<2x128xi64>
      %15 = arith.addi %14, %c30522_i64 : i64
      %16 = arith.cmpi slt, %14, %c0_i64 : i64
      %17 = arith.select %16, %15, %14 : i64
      memref.store %17, %1[%arg1] : memref<256xi64>
    }
    ...
    scf.for %arg1 = %c0 to %c256 step %c1 {
      ...
      %13 = arith.select %8, %12, %11 : index
      %14 = memref.load %arg0[%13, %7] : memref<2x128xi64>
      %15 = arith.cmpi ne, %14, %c0_i64 : i64
      memref.store %15, %2[%arg1] : memref<256xi1>
    }
  ...
  func private @Unknown2(%arg0: memref<128xi64>) -> (memref<256xui32>, memref<256x1xi64>, memref<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg1 = %c0 to %c256 step %c1 {
      %7 = arith.remsi %arg1, %c128 : index
      %8 = arith.cmpi slt, %7, %c0 : index
      %9 = arith.addi %7, %c128 : index
      %10 = arith.select %8, %9, %7 : index
      %11 = arith.cmpi slt, %arg1, %c0 : index
      %12 = arith.subi %c-1, %arg1 : index
      %13 = arith.select %11, %12, %arg1 : index
      ...
      memref.store %19, %0[%16, %10] : memref<2x128xui32>
    }
    ...
    scf.for %arg1 = %c0 to %c256 step %c1 {
      ...
      %16 = arith.select %11, %15, %14 : index
      %17 = memref.load %arg0[%10] : memref<128xi64>
      %18 = arith.addi %17, %c2_i64 : i64
      %19 = arith.cmpi slt, %17, %c0_i64 : i64
      %20 = arith.select %19, %18, %17 : i64
      memref.store %20, %1[%16, %10] : memref<2x128xi64>
    }
    ...
    scf.for %arg1 = %c0 to %c256 step %c1 {
      ...
      %16 = arith.select %11, %15, %14 : index
      %17 = memref.load %arg0[%10] : memref<128xi64>
      %18 = arith.cmpi ne, %17, %c-1_i64 : i64
      memref.store %18, %2[%16, %10] : memref<2x128xi1>
    }
  ...
  func private @Unknown3(%arg0: memref<1x128xi64>) -> (memref<128xui32>, memref<128x1xi64>, memref<128xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg1 = %c0 to %c128 step %c1 {
      %5 = memref.load %3[%arg1] : memref<128xi64>
      %6 = arith.trunci %5 : i64 to i32
      %7 = builtin.unrealized_conversion_cast %6 : i32 to ui32
      memref.store %7, %0[%arg1] : memref<128xui32>
    }
    scf.for %arg1 = %c0 to %c128 step %c1 {
      %5 = memref.load %3[%arg1] : memref<128xi64>
  ...
  func private @Unknown4(%arg0: memref<256x128xf32>, %arg1: memref<256x128xf32>, %arg2: memref<128x128xf32>) -> memref<2x128x128xf32> attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg3 = %c0 to %c32768 step %c1 {
      ...
      %21 = memref.load %arg0[%10, %4] : memref<256x128xf32>
      %22 = memref.load %arg1[%10, %4] : memref<256x128xf32>
      %23 = memref.load %arg2[%14, %4] : memref<128x128xf32>
      %24 = arith.addf %21, %22 : f32
      %25 = arith.addf %24, %23 : f32
      memref.store %25, %0[%20, %14, %4] : memref<2x128x128xf32>
    }
  ...
  func private @Unknown5(%arg0: memref<256x30522xf32>, %arg1: memref<30522xf32>) -> (memref<2x128x30522xf32>, memref<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg2 = %c0 to %c7813632 step %c1 {
      ...
      %23 = memref.load %arg0[%12, %6] : memref<256x30522xf32>
      %24 = memref.load %arg1[%6] : memref<30522xf32>
      %25 = arith.addf %23, %24 : f32
      memref.store %25, %0[%22, %16, %6] : memref<2x128x30522xf32>
    }
    scf.for %arg2 = %c0 to %c7813632 step %c1 {
      %3 = arith.remsi %arg2, %c30522 : index
      %4 = arith.cmpi slt, %3, %c0 : index
      ...
      %21 = arith.subi %c-1, %20 : index
      %22 = arith.select %17, %21, %20 : index
      %23 = memref.load %2[%22, %16, %6] : memref<2x128x30522xf32>
      %24 = memref.load %arg1[%6] : memref<30522xf32>
      %25 = arith.addf %23, %24 : f32
      memref.store %25, %1[%12, %6] : memref<256x30522xf32>
    }
  ...
  func private @Unknown6(%arg0: memref<256xf32>, %arg1: memref<256x30522xf32>) -> (memref<256x30522xf32>, memref<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg2 = %c0 to %c7813632 step %c1 {
      ...
      %14 = arith.subf %12, %13 : f32
      %15 = math.exp %14 : f32
      memref.store %15, %1[%11, %5] : memref<256x30522xf32>
    }
  ...
  func private @Unknown8(%arg0: memref<256xf32>, %arg1: memref<256x30522xf32>, %arg2: memref<256xi64>, %arg3: memref<256xi1>) -> (memref<256x30522xf32>, memref<256x30522xf32>, memref<256x30522xf32>, memref<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg4 = %c0 to %c7813632 step %c1 {
      %4 = arith.remsi %arg4, %c30522 : index
      %5 = arith.cmpi slt, %4, %c0 : index
      %6 = arith.addi %4, %c30522 : index
      %7 = arith.select %5, %6, %4 : index
      %8 = arith.cmpi slt, %arg4, %c0 : index
      %9 = arith.subi %c-1, %arg4 : index
      %10 = arith.select %8, %9, %arg4 : index
      %11 = arith.divsi %10, %c30522 : index
      %12 = arith.subi %c-1, %11 : index
      %13 = arith.select %8, %12, %11 : index
      %14 = memref.load %arg3[%13] : memref<256xi1>
      %15 = memref.load %arg2[%13] : memref<256xi64>
      %16 = arith.index_cast %7 : index to i64
      %17 = arith.cmpi eq, %15, %16 : i64
      %18 = arith.select %17, %cst, %cst_0 : f32
      %19 = arith.select %14, %cst, %cst_0 : f32
      %20 = arith.mulf %19, %18 : f32
      memref.store %20, %0[%13, %7] : memref<256x30522xf32>
    }
    scf.for %arg4 = %c0 to %c7813632 step %c1 {
      %4 = arith.remsi %arg4, %c30522 : index
      %5 = arith.cmpi slt, %4, %c0 : index
      ...
      %12 = arith.subi %c-1, %11 : index
      %13 = arith.select %8, %12, %11 : index
      %14 = memref.load %arg2[%13] : memref<256xi64>
      %15 = memref.load %arg1[%13, %7] : memref<256x30522xf32>
      %16 = memref.load %arg0[%13] : memref<256xf32>
      %17 = memref.load %arg3[%13] : memref<256xi1>
      %18 = arith.index_cast %7 : index to i64
      %19 = arith.cmpi eq, %14, %18 : i64
      %20 = arith.select %19, %cst, %cst_0 : f32
      %21 = arith.select %17, %cst, %cst_0 : f32
      %22 = arith.mulf %21, %20 : f32
      %23 = arith.subf %15, %16 : f32
      %24 = arith.negf %20 : f32
      %25 = arith.mulf %24, %23 : f32
      %26 = arith.cmpf une, %20, %cst : f32
      %27 = arith.select %26, %cst_0, %25 : f32
      %28 = arith.mulf %27, %22 : f32
      memref.store %28, %1[%13, %7] : memref<256x30522xf32>
    }
    scf.for %arg4 = %c0 to %c7813632 step %c1 {
      %4 = arith.remsi %arg4, %c30522 : index
      %5 = arith.cmpi slt, %4, %c0 : index
      ...
      %13 = arith.select %8, %12, %11 : index
      %14 = memref.load %arg2[%13] : memref<256xi64>
      %15 = memref.load %arg3[%13] : memref<256xi1>
      %16 = arith.index_cast %7 : index to i64
      %17 = arith.cmpi eq, %14, %16 : i64
      %18 = arith.select %17, %cst, %cst_0 : f32
      %19 = arith.select %15, %cst, %cst_0 : f32
      %20 = arith.mulf %19, %18 : f32
      %21 = arith.negf %18 : f32
      %22 = arith.mulf %21, %20 : f32
      memref.store %22, %2[%13, %7] : memref<256x30522xf32>
    }
    scf.for %arg4 = %c0 to %c7813632 step %c1 {
      %4 = arith.remsi %arg4, %c30522 : index
      %5 = arith.cmpi slt, %4, %c0 : index
      ...
      %12 = arith.subi %c-1, %11 : index
      %13 = arith.select %8, %12, %11 : index
      %14 = memref.load %arg1[%13, %7] : memref<256x30522xf32>
      %15 = memref.load %arg0[%13] : memref<256xf32>
      %16 = arith.subf %14, %15 : f32
      %17 = math.exp %16 : f32
      memref.store %17, %3[%13, %7] : memref<256x30522xf32>
    }
  ...
  func private @Unknown12(%arg0: memref<256xf32>, %arg1: memref<256x30522xf32>, %arg2: memref<256x30522xf32>) -> (memref<256x30522xf32>, memref<2x128x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg3 = %c0 to %c7813632 step %c1 {
      %3 = arith.remsi %arg3, %c30522 : index
      %4 = arith.cmpi slt, %3, %c0 : index
      %5 = arith.addi %3, %c30522 : index
      %6 = arith.select %4, %5, %3 : index
      ...
      %11 = arith.subi %c-1, %10 : index
      %12 = arith.select %7, %11, %10 : index
      %13 = memref.load %arg2[%12, %6] : memref<256x30522xf32>
      %14 = memref.load %arg1[%12, %6] : memref<256x30522xf32>
      %15 = memref.load %arg0[%12] : memref<256xf32>
      %16 = arith.mulf %14, %15 : f32
      %17 = arith.subf %13, %16 : f32
      memref.store %17, %0[%12, %6] : memref<256x30522xf32>
    }
    ...
    scf.for %arg3 = %c0 to %c7813632 step %c1 {
      ...
      %21 = arith.subi %c-1, %20 : index
      %22 = arith.select %17, %21, %20 : index
      %23 = memref.load %arg2[%12, %6] : memref<256x30522xf32>
      %24 = memref.load %arg1[%12, %6] : memref<256x30522xf32>
      %25 = memref.load %2[%22, %16] : memref<2x128xf32>
      %26 = arith.mulf %24, %25 : f32
      %27 = arith.subf %23, %26 : f32
      memref.store %27, %1[%22, %16, %6] : memref<2x128x30522xf32>
    }
  ...
  func private @Unknown18(%arg0: memref<256xi1>, %arg1: memref<2x128x128xf32>, %arg2: memref<256xi1>) -> (memref<256x128xf32>, memref<256x128xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    scf.for %arg3 = %c0 to %c32768 step %c1 {
      ...
      %18 = arith.cmpi slt, %13, %c0 : index
      %19 = arith.subi %c-1, %13 : index
      %20 = arith.select %18, %19, %13 : index
      %21 = arith.divsi %20, %c128 : index
      %22 = arith.subi %c-1, %21 : index
      %23 = arith.select %18, %22, %21 : index
      %24 = memref.load %2[%23, %17] : memref<2x128xi1>
      %25 = memref.load %arg1[%23, %17, %7] : memref<2x128x128xf32>
      %26 = arith.select %24, %25, %cst : f32
      memref.store %26, %0[%13, %7] : memref<256x128xf32>
    }
    ...
    scf.for %arg3 = %c0 to %c32768 step %c1 {
      ...
      %22 = arith.subi %c-1, %21 : index
      %23 = arith.select %18, %22, %21 : index
      %24 = memref.load %3[%23, %17] : memref<2x128xi1>
      %25 = memref.load %arg1[%23, %17, %7] : memref<2x128x128xf32>
      %26 = arith.select %24, %25, %cst : f32
      memref.store %26, %1[%13, %7] : memref<256x128xf32>
    }
