...
module {
  func.func private @Unknown0(%arg0: tensor<2x128xi64>) -> (tensor<256xi64>, tensor<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %1 = linalg.init_tensor [256] : tensor<256xi1>
    %2 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%0 : tensor<256xi64>) outs(%1 : tensor<256xi1>) {
    ^bb0(%arg1: i64, %arg2: i1):
      %3 = arith.cmpi ne, %arg1, %c-100_i64 : i64
      linalg.yield %3 : i1
    } -> tensor<256xi1>
    return %0, %2 : tensor<256xi64>, tensor<256xi1>
  }
  func.func private @Unknown1(%arg0: tensor<2x128xi64>) -> (tensor<256xui32>, tensor<256x1xi64>, tensor<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %0 = tensor.collapse_shape %arg0 [[0, 1]] : tensor<2x128xi64> into tensor<256xi64>
    %1 = linalg.init_tensor [256] : tensor<256xui32>
    %2 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%0 : tensor<256xi64>) outs(%1 : tensor<256xui32>) {
    ^bb0(%arg1: i64, %arg2: ui32):
      %9 = arith.trunci %arg1 : i64 to i32
      %10 = builtin.unrealized_conversion_cast %9 : i32 to ui32
      linalg.yield %10 : ui32
    } -> tensor<256xui32>
    %3 = linalg.init_tensor [256, 1] : tensor<256x1xi64>
    %4 = tensor.collapse_shape %3 [[0, 1]] : tensor<256x1xi64> into tensor<256xi64>
    %5 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%0 : tensor<256xi64>) outs(%4 : tensor<256xi64>) {
    ^bb0(%arg1: i64, %arg2: i64):
      %9 = arith.addi %arg1, %c30522_i64 : i64
      %10 = arith.cmpi slt, %arg1, %c0_i64 : i64
      %11 = arith.select %10, %9, %arg1 : i64
      linalg.yield %11 : i64
    } -> tensor<256xi64>
    %6 = tensor.expand_shape %5 [[0, 1]] : tensor<256xi64> into tensor<256x1xi64>
    %7 = linalg.init_tensor [256] : tensor<256xi1>
    %8 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%0 : tensor<256xi64>) outs(%7 : tensor<256xi1>) {
    ^bb0(%arg1: i64, %arg2: i1):
      %9 = arith.sitofp %arg1 : i64 to f64
  ...
  func.func private @Unknown2(%arg0: tensor<128xi64>) -> (tensor<256xui32>, tensor<256x1xi64>, tensor<256xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %c0_i64 = arith.constant 0 : i64
    %0 = linalg.init_tensor [2, 128] : tensor<2x128xi64>
    %1 = linalg.generic {indexing_maps = [#map1, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg0 : tensor<128xi64>) outs(%0 : tensor<2x128xi64>) {
    ^bb0(%arg1: i64, %arg2: i64):
      linalg.yield %arg1 : i64
    } -> tensor<2x128xi64>
    %2 = linalg.init_tensor [256] : tensor<256xui32>
    %3 = tensor.expand_shape %2 [[0, 1]] : tensor<256xui32> into tensor<2x128xui32>
    %4 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%1 : tensor<2x128xi64>) outs(%3 : tensor<2x128xui32>) {
    ^bb0(%arg1: i64, %arg2: ui32):
      %16 = arith.trunci %arg1 : i64 to i32
      %17 = builtin.unrealized_conversion_cast %16 : i32 to ui32
      linalg.yield %17 : ui32
    } -> tensor<2x128xui32>
    %5 = tensor.collapse_shape %4 [[0, 1]] : tensor<2x128xui32> into tensor<256xui32>
    %6 = linalg.init_tensor [256, 1] : tensor<256x1xi64>
    %7 = tensor.collapse_shape %6 [[0, 1]] : tensor<256x1xi64> into tensor<256xi64>
    %8 = tensor.expand_shape %7 [[0, 1]] : tensor<256xi64> into tensor<2x128xi64>
    %9 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%1 : tensor<2x128xi64>) outs(%8 : tensor<2x128xi64>) {
    ^bb0(%arg1: i64, %arg2: i64):
      %16 = arith.addi %arg1, %c2_i64 : i64
      %17 = arith.cmpi slt, %arg1, %c0_i64 : i64
      %18 = arith.select %17, %16, %arg1 : i64
      linalg.yield %18 : i64
    } -> tensor<2x128xi64>
    %10 = tensor.collapse_shape %9 [[0, 1]] : tensor<2x128xi64> into tensor<256xi64>
    %11 = tensor.expand_shape %10 [[0, 1]] : tensor<256xi64> into tensor<256x1xi64>
    %12 = linalg.init_tensor [256] : tensor<256xi1>
    %13 = tensor.expand_shape %12 [[0, 1]] : tensor<256xi1> into tensor<2x128xi1>
    %14 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%1 : tensor<2x128xi64>) outs(%13 : tensor<2x128xi1>) {
    ^bb0(%arg1: i64, %arg2: i1):
      %16 = arith.sitofp %arg1 : i64 to f64
      %17 = arith.cmpf une, %16, %cst : f64
      linalg.yield %17 : i1
    } -> tensor<2x128xi1>
    %15 = tensor.collapse_shape %14 [[0, 1]] : tensor<2x128xi1> into tensor<256xi1>
    return %5, %11, %15 : tensor<256xui32>, tensor<256x1xi64>, tensor<256xi1>
  }
  func.func private @Unknown3(%arg0: tensor<1x128xi64>) -> (tensor<128xui32>, tensor<128x1xi64>, tensor<128xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %3 = linalg.init_tensor [128, 1] : tensor<128x1xi64>
    %4 = tensor.collapse_shape %3 [[0, 1]] : tensor<128x1xi64> into tensor<128xi64>
    %5 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%0 : tensor<128xi64>) outs(%4 : tensor<128xi64>) {
    ^bb0(%arg1: i64, %arg2: i64):
      %9 = arith.addi %arg1, %c512_i64 : i64
      %10 = arith.cmpi slt, %arg1, %c0_i64 : i64
      %11 = arith.select %10, %9, %arg1 : i64
      linalg.yield %11 : i64
    } -> tensor<128xi64>
    %6 = tensor.expand_shape %5 [[0, 1]] : tensor<128xi64> into tensor<128x1xi64>
    %7 = linalg.init_tensor [128] : tensor<128xi1>
    %8 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%0 : tensor<128xi64>) outs(%7 : tensor<128xi1>) {
    ^bb0(%arg1: i64, %arg2: i1):
      %9 = arith.sitofp %arg1 : i64 to f64
      %10 = arith.cmpf une, %9, %cst : f64
      linalg.yield %10 : i1
    } -> tensor<128xi1>
    return %2, %6, %8 : tensor<128xui32>, tensor<128x1xi64>, tensor<128xi1>
  }
  func.func private @Unknown4(%arg0: tensor<256x128xf32>, %arg1: tensor<256x128xf32>, %arg2: tensor<128x128xf32>) -> tensor<2x128x128xf32> attributes {__byteir_elementwise_fusion__} {
    %0 = tensor.expand_shape %arg0 [[0, 1], [2]] : tensor<256x128xf32> into tensor<2x128x128xf32>
    %1 = tensor.expand_shape %arg1 [[0, 1], [2]] : tensor<256x128xf32> into tensor<2x128x128xf32>
    %2 = linalg.init_tensor [2, 128, 128] : tensor<2x128x128xf32>
    %3 = linalg.generic {indexing_maps = [#map3, #map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel"]} ins(%0, %1, %arg2 : tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) outs(%2 : tensor<2x128x128xf32>) {
  ...
  func.func private @Unknown5(%arg0: tensor<256x30522xf32>, %arg1: tensor<30522xf32>) -> (tensor<2x128x30522xf32>, tensor<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    %0 = linalg.init_tensor [2, 128, 30522] : tensor<2x128x30522xf32>
    %1 = tensor.collapse_shape %0 [[0, 1], [2]] : tensor<2x128x30522xf32> into tensor<256x30522xf32>
    %2 = linalg.generic {indexing_maps = [#map2, #map1, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg0, %arg1 : tensor<256x30522xf32>, tensor<30522xf32>) outs(%1 : tensor<256x30522xf32>) {
    ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
      %4 = arith.addf %arg2, %arg3 : f32
      linalg.yield %4 : f32
    } -> tensor<256x30522xf32>
    %3 = tensor.expand_shape %2 [[0, 1], [2]] : tensor<256x30522xf32> into tensor<2x128x30522xf32>
    return %3, %2 : tensor<2x128x30522xf32>, tensor<256x30522xf32>
  }
  func.func private @Unknown6(%arg0: tensor<256xf32>, %arg1: tensor<256x30522xf32>) -> (tensor<256x30522xf32>, tensor<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    %1 = linalg.generic {indexing_maps = [#map2, #map5, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg1, %arg0 : tensor<256x30522xf32>, tensor<256xf32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
      %3 = arith.subf %arg2, %arg3 : f32
      linalg.yield %3 : f32
    } -> tensor<256x30522xf32>
    %2 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%1 : tensor<256x30522xf32>) outs(%0 : tensor<256x30522xf32>) {
  ...
  func.func private @Unknown7(%arg0: tensor<256xf32>) -> tensor<256xf32> attributes {__byteir_elementwise_fusion__} {
    ...
    %1 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%arg0 : tensor<256xf32>) outs(%0 : tensor<256xf32>) {
  ...
  func.func private @Unknown8(%arg0: tensor<256xf32>, %arg1: tensor<256x30522xf32>, %arg2: tensor<256xi64>, %arg3: tensor<256xi1>) -> (tensor<256x30522xf32>, tensor<256x30522xf32>, tensor<256x30522xf32>, tensor<256x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    ^bb0(%arg4: f32, %arg5: f32, %arg6: f32):
      %8 = arith.subf %arg4, %arg5 : f32
      linalg.yield %8 : f32
    } -> tensor<256x30522xf32>
    %2 = linalg.generic {indexing_maps = [#map5, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg2 : tensor<256xi64>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg4: i64, %arg5: f32):
      %8 = linalg.index 1 : index
      %9 = arith.index_cast %8 : index to i64
      %10 = arith.cmpi eq, %arg4, %9 : i64
      %11 = arith.select %10, %cst, %cst_0 : f32
      linalg.yield %11 : f32
    } -> tensor<256x30522xf32>
    %3 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%2 : tensor<256x30522xf32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg4: f32, %arg5: f32):
      %8 = arith.negf %arg4 : f32
      linalg.yield %8 : f32
    } -> tensor<256x30522xf32>
    %4 = linalg.generic {indexing_maps = [#map5, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg3, %2 : tensor<256xi1>, tensor<256x30522xf32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg4: i1, %arg5: f32, %arg6: f32):
      %8 = arith.select %arg4, %cst, %cst_0 : f32
      %9 = arith.mulf %8, %arg5 : f32
      linalg.yield %9 : f32
    } -> tensor<256x30522xf32>
    %5 = linalg.generic {indexing_maps = [#map2, #map2, #map2, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%2, %3, %1, %4 : tensor<256x30522xf32>, tensor<256x30522xf32>, tensor<256x30522xf32>, tensor<256x30522xf32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg4: f32, %arg5: f32, %arg6: f32, %arg7: f32, %arg8: f32):
      %8 = arith.mulf %arg5, %arg6 : f32
      %9 = arith.cmpf une, %arg4, %cst : f32
      %10 = arith.select %9, %cst_0, %8 : f32
      %11 = arith.mulf %10, %arg7 : f32
      linalg.yield %11 : f32
    } -> tensor<256x30522xf32>
    %6 = linalg.generic {indexing_maps = [#map2, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%3, %4 : tensor<256x30522xf32>, tensor<256x30522xf32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg4: f32, %arg5: f32, %arg6: f32):
      %8 = arith.mulf %arg4, %arg5 : f32
      linalg.yield %8 : f32
    } -> tensor<256x30522xf32>
    %7 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%1 : tensor<256x30522xf32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg4: f32, %arg5: f32):
      %8 = math.exp %arg4 : f32
      linalg.yield %8 : f32
    } -> tensor<256x30522xf32>
  ...
  func.func private @Unknown9(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> attributes {__byteir_elementwise_fusion__} {
    ...
    %1 = linalg.generic {indexing_maps = [#map6, #map6, #map6], iterator_types = []} ins(%arg0, %arg1 : tensor<f32>, tensor<f32>) outs(%0 : tensor<f32>) {
    ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
  ...
  func.func private @Unknown11(%arg0: tensor<f32>, %arg1: tensor<256x30522xf32>) -> tensor<256x30522xf32> attributes {__byteir_elementwise_fusion__} {
    %0 = linalg.init_tensor [256, 30522] : tensor<256x30522xf32>
    %1 = linalg.generic {indexing_maps = [#map2, #map7, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg1, %arg0 : tensor<256x30522xf32>, tensor<f32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
      %2 = arith.divf %arg2, %arg3 : f32
      linalg.yield %2 : f32
    } -> tensor<256x30522xf32>
  ...
  func.func private @Unknown12(%arg0: tensor<256xf32>, %arg1: tensor<256x30522xf32>, %arg2: tensor<256x30522xf32>) -> (tensor<256x30522xf32>, tensor<2x128x30522xf32>) attributes {__byteir_elementwise_fusion__} {
    %0 = linalg.init_tensor [256, 30522] : tensor<256x30522xf32>
    %1 = linalg.generic {indexing_maps = [#map2, #map2, #map5, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg2, %arg1, %arg0 : tensor<256x30522xf32>, tensor<256x30522xf32>, tensor<256xf32>) outs(%0 : tensor<256x30522xf32>) {
    ^bb0(%arg3: f32, %arg4: f32, %arg5: f32, %arg6: f32):
      %3 = arith.mulf %arg4, %arg5 : f32
      %4 = arith.subf %arg3, %3 : f32
      linalg.yield %4 : f32
    } -> tensor<256x30522xf32>
    %2 = tensor.expand_shape %1 [[0, 1], [2]] : tensor<256x30522xf32> into tensor<2x128x30522xf32>
    return %1, %2 : tensor<256x30522xf32>, tensor<2x128x30522xf32>
  }
  ...
  func.func private @Unknown18(%arg0: tensor<256xi1>, %arg1: tensor<2x128x128xf32>, %arg2: tensor<256xi1>) -> (tensor<256x128xf32>, tensor<256x128xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    %0 = tensor.collapse_shape %arg1 [[0, 1], [2]] : tensor<2x128x128xf32> into tensor<256x128xf32>
    %1 = linalg.init_tensor [256, 128] : tensor<256x128xf32>
    %2 = linalg.generic {indexing_maps = [#map5, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg0, %0 : tensor<256xi1>, tensor<256x128xf32>) outs(%1 : tensor<256x128xf32>) {
    ^bb0(%arg3: i1, %arg4: f32, %arg5: f32):
      %4 = arith.select %arg3, %arg4, %cst : f32
      linalg.yield %4 : f32
    } -> tensor<256x128xf32>
    %3 = linalg.generic {indexing_maps = [#map5, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg2, %0 : tensor<256xi1>, tensor<256x128xf32>) outs(%1 : tensor<256x128xf32>) {
    ^bb0(%arg3: i1, %arg4: f32, %arg5: f32):
      %4 = arith.select %arg3, %arg4, %cst : f32
      linalg.yield %4 : f32
    } -> tensor<256x128xf32>
    return %2, %3 : tensor<256x128xf32>, tensor<256x128xf32>
  }
  func.func private @Unknown19(%arg0: tensor<128xi1>, %arg1: tensor<128x128xf32>) -> tensor<128x128xf32> attributes {__byteir_elementwise_fusion__} {
    ...
    %1 = linalg.generic {indexing_maps = [#map5, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%arg0, %arg1 : tensor<128xi1>, tensor<128x128xf32>) outs(%0 : tensor<128x128xf32>) {
