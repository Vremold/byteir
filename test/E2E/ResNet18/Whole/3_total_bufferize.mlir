...
module @IrToMhlo.2452 {
  ...
  func.func private @Unknown25(%arg0: tensor<4x64x112x112xf16>) -> (tensor<4x64x112x112xf16>, tensor<4x64x112x112xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %3 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1 : tensor<4x64x112x112xf16>) outs(%2 : tensor<4x64x112x112xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %4 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %4 : i1
  ...
  func.func private @Unknown27(%arg0: tensor<4x64x56x56xf16>) -> (tensor<4x64x56x56xf16>, tensor<4x64x56x56xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %3 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1 : tensor<4x64x56x56xf16>) outs(%2 : tensor<4x64x56x56xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %4 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %4 : i1
  ...
  func.func private @Unknown29(%arg0: tensor<4x64x56x56xf16>, %arg1: tensor<4x64x56x56xf16>) -> (tensor<4x64x56x56xf16>, tensor<4x64x56x56xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %2 = linalg.init_tensor [4, 64, 56, 56] : tensor<4x64x56x56xi1>
    %3 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1 : tensor<4x64x56x56xf16>) outs(%2 : tensor<4x64x56x56xi1>) {
    ^bb0(%arg2: f16, %arg3: i1):
      %4 = arith.cmpf ogt, %arg2, %cst : f16
      linalg.yield %4 : i1
    } -> tensor<4x64x56x56xi1>
    return %1, %3 : tensor<4x64x56x56xf16>, tensor<4x64x56x56xi1>
  }
  ...
  func.func private @Unknown36(%arg0: tensor<4x128x28x28xf16>) -> (tensor<4x128x28x28xf16>, tensor<4x128x28x28xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %3 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1 : tensor<4x128x28x28xf16>) outs(%2 : tensor<4x128x28x28xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %4 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %4 : i1
  ...
  func.func private @Unknown45(%arg0: tensor<4x256x14x14xf16>) -> (tensor<4x256x14x14xf16>, tensor<4x256x14x14xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %3 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1 : tensor<4x256x14x14xf16>) outs(%2 : tensor<4x256x14x14xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %4 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %4 : i1
  ...
  func.func private @Unknown54(%arg0: tensor<4x512x7x7xf16>) -> (tensor<4x512x7x7xf16>, tensor<4x512x7x7xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    %3 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%1 : tensor<4x512x7x7xf16>) outs(%2 : tensor<4x512x7x7xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %4 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %4 : i1
    } -> tensor<4x512x7x7xi1>
  ...
  func.func private @Unknown65(%arg0: tensor<4xf16>, %arg1: tensor<4x1000xf16>, %arg2: tensor<4xf16>, %arg3: tensor<4x1000xf16>, %arg4: tensor<4x1000xf32>) -> (tensor<4x1000xf16>, tensor<4x1000xf32>, tensor<4x1000xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    ^bb0(%arg5: f16, %arg6: f16, %arg7: f16, %arg8: f16):
      %6 = math.exp %arg6 : f16
      %7 = arith.mulf %6, %arg7 : f16
      %8 = arith.subf %arg5, %7 : f16
      linalg.yield %8 : f16
    } -> tensor<4x1000xf16>
    %3 = linalg.init_tensor [4, 1000] : tensor<4x1000xf32>
    ...
    ^bb0(%arg5: f16, %arg6: f32, %arg7: f32):
      %6 = arith.extf %arg5 : f16 to f32
      %7 = arith.mulf %6, %arg6 : f32
      linalg.yield %7 : f32
    } -> tensor<4x1000xf32>
