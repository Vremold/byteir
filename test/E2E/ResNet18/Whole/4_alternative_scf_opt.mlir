...
module @IrToMhlo.2452 {
  ...
  func.func private @Unknown25(%arg0: memref<4x64x112x112xf16>) -> (memref<4x64x112x112xf16>, memref<4x64x112x112xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%0 : memref<4x64x112x112xf16>) outs(%1 : memref<4x64x112x112xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %2 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %2 : i1
    }
  ...
  func.func private @Unknown27(%arg0: memref<4x64x56x56xf16>) -> (memref<4x64x56x56xf16>, memref<4x64x56x56xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%0 : memref<4x64x56x56xf16>) outs(%1 : memref<4x64x56x56xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %2 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %2 : i1
    }
  ...
  func.func private @Unknown36(%arg0: memref<4x128x28x28xf16>) -> (memref<4x128x28x28xf16>, memref<4x128x28x28xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%0 : memref<4x128x28x28xf16>) outs(%1 : memref<4x128x28x28xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %2 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %2 : i1
    }
  ...
  func.func private @Unknown45(%arg0: memref<4x256x14x14xf16>) -> (memref<4x256x14x14xf16>, memref<4x256x14x14xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%0 : memref<4x256x14x14xf16>) outs(%1 : memref<4x256x14x14xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %2 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %2 : i1
    }
  ...
  func.func private @Unknown54(%arg0: memref<4x512x7x7xf16>) -> (memref<4x512x7x7xf16>, memref<4x512x7x7xi1>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%0 : memref<4x512x7x7xf16>) outs(%1 : memref<4x512x7x7xi1>) {
    ^bb0(%arg1: f16, %arg2: i1):
      %2 = arith.cmpf ogt, %arg1, %cst : f16
      linalg.yield %2 : i1
    }
  ...
  func.func private @Unknown63(%arg0: memref<4xf16>, %arg1: memref<4x1000xf16>) -> (memref<4x1000xf16>, memref<4x1000xf16>) attributes {__byteir_elementwise_fusion__} {
    ...
    linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%0 : memref<4x1000xf16>) outs(%1 : memref<4x1000xf16>) {
  ...
  func.func private @Unknown65(%arg0: memref<4xf16>, %arg1: memref<4x1000xf16>, %arg2: memref<4xf16>, %arg3: memref<4x1000xf16>, %arg4: memref<4x1000xf32>) -> (memref<4x1000xf16>, memref<4x1000xf32>, memref<4x1000xf32>) attributes {__byteir_elementwise_fusion__} {
    ...
    ^bb0(%arg5: f16, %arg6: f16, %arg7: f16):
      %4 = arith.subf %arg5, %arg6 : f16
      linalg.yield %4 : f16
    }
    %1 = memref.alloc() {alignment = 128 : i64} : memref<4x1000xf16>
    linalg.generic {indexing_maps = [#map1, #map1, #map4, #map1], iterator_types = ["parallel", "parallel"]} ins(%arg3, %0, %arg2 : memref<4x1000xf16>, memref<4x1000xf16>, memref<4xf16>) outs(%1 : memref<4x1000xf16>) {
    ^bb0(%arg5: f16, %arg6: f16, %arg7: f16, %arg8: f16):
      %4 = math.exp %arg6 : f16
      %5 = arith.mulf %4, %arg7 : f16
      %6 = arith.subf %arg5, %5 : f16
      linalg.yield %6 : f16
    }
    %2 = memref.alloc() {alignment = 128 : i64} : memref<4x1000xf32>
    linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%0, %arg4 : memref<4x1000xf16>, memref<4x1000xf32>) outs(%2 : memref<4x1000xf32>) {
    ^bb0(%arg5: f16, %arg6: f32, %arg7: f32):
      %4 = arith.extf %arg5 : f16 to f32
      %5 = arith.mulf %4, %arg6 : f32
      linalg.yield %5 : f32
    }
    %3 = memref.alloc() {alignment = 128 : i64} : memref<4x1000xf32>
    linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%1 : memref<4x1000xf16>) outs(%3 : memref<4x1000xf32>) {
  ...
  func.func private @Unknown66(%arg0: memref<4x512xf16>, %arg1: memref<4x512x7x7xi1>) -> memref<4x512x7x7xf16> attributes {__byteir_elementwise_fusion__} {
    ...
    ^bb0(%arg2: i1, %arg3: f16, %arg4: f16):
      ...
      %2 = arith.select %arg2, %1, %cst_0 : f16
      linalg.yield %2 : f16
    }
  ...
  func.func private @Unknown70(%arg0: memref<4x512x7x7xi1>, %arg1: memref<4x512x7x7xf16>) -> memref<4x512x7x7xf16> attributes {__byteir_elementwise_fusion__} {
    ...
    ^bb0(%arg2: i1, %arg3: f16, %arg4: f16):
      %1 = arith.select %arg2, %arg3, %cst : f16
      linalg.yield %1 : f16
    }
    return %0 : memref<4x512x7x7xf16>
  }
