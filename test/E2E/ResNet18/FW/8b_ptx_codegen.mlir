...
// CHECK-LABEL: .visible .entry Unknown100
module attributes {byre.container_module, gpu.container_module} {
  gpu.module @unified {
    ...
    llvm.func @Unknown60(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: !llvm.ptr<f16>, %arg6: !llvm.ptr<f16>, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: i64, %arg11: i64, %arg12: !llvm.ptr<f16>, %arg13: !llvm.ptr<f16>, %arg14: i64, %arg15: i64, %arg16: i64, %arg17: i64, %arg18: i64) attributes {gpu.kernel, nvvm.kernel} {
      ...
      %23 = llvm.mlir.null : !llvm.ptr<f16>
      %24 = llvm.getelementptr %23[%13] : (!llvm.ptr<f16>, i64) -> !llvm.ptr<f16>
      %25 = llvm.ptrtoint %24 : !llvm.ptr<f16> to i64
      %26 = llvm.alloca %25 x f16 : (i64) -> !llvm.ptr<f16>
      %27 = llvm.mlir.undef : !llvm.struct<(ptr<f16>, ptr<f16>, i64, array<1 x i64>, array<1 x i64>)>
      %28 = llvm.insertvalue %26, %27[0] : !llvm.struct<(ptr<f16>, ptr<f16>, i64, array<1 x i64>, array<1 x i64>)>
      %29 = llvm.insertvalue %26, %28[1] : !llvm.struct<(ptr<f16>, ptr<f16>, i64, array<1 x i64>, array<1 x i64>)>
      %30 = llvm.icmp "slt" %22, %13 : i64
      llvm.cond_br %30, ^bb1, ^bb2
    ^bb1:  // pred: ^bb0
      %31 = llvm.getelementptr %arg1[%22] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
      %32 = llvm.load %31 : !llvm.ptr<f32>
      %33 = llvm.fptrunc %32 : f32 to f16
      %34 = llvm.getelementptr %26[%22] : (!llvm.ptr<f16>, i64) -> !llvm.ptr<f16>
      llvm.store %33, %34 : !llvm.ptr<f16>
      %35 = llvm.icmp "slt" %22, %12 : i64
      %36 = llvm.add %22, %13  : i64
      %37 = llvm.select %35, %36, %22 : i1, i64
      %38 = llvm.sub %14, %22  : i64
      %39 = llvm.select %35, %38, %22 : i1, i64
      %40 = llvm.sdiv %39, %13  : i64
      %41 = llvm.sub %14, %40  : i64
      %42 = llvm.select %35, %41, %40 : i1, i64
      %43 = llvm.mul %42, %13  : i64
      %44 = llvm.add %43, %37  : i64
      %45 = llvm.getelementptr %arg6[%44] : (!llvm.ptr<f16>, i64) -> !llvm.ptr<f16>
      %46 = llvm.load %45 : !llvm.ptr<f16>
      %47 = llvm.getelementptr %26[%37] : (!llvm.ptr<f16>, i64) -> !llvm.ptr<f16>
      %48 = llvm.load %47 : !llvm.ptr<f16>
      %49 = llvm.fadd %46, %48  : f16
      %50 = llvm.getelementptr %arg13[%44] : (!llvm.ptr<f16>, i64) -> !llvm.ptr<f16>
    ...
    ^bb1:  // pred: ^bb0
      %22 = llvm.icmp "slt" %20, %10 : i64
      %23 = llvm.add %20, %11  : i64
      %24 = llvm.select %22, %23, %20 : i1, i64
      %25 = llvm.sub %12, %20  : i64
      %26 = llvm.select %22, %25, %20 : i1, i64
      %27 = llvm.sdiv %26, %11  : i64
      %28 = llvm.sub %12, %27  : i64
      %29 = llvm.select %22, %28, %27 : i1, i64
      %30 = llvm.mul %29, %11  : i64
      %31 = llvm.add %30, %24  : i64
      %32 = llvm.getelementptr %arg1[%31] : (!llvm.ptr<f16>, i64) -> !llvm.ptr<f16>
      %33 = llvm.load %32 : !llvm.ptr<f16>
      %34 = llvm.fmul %33, %9  : f16
      %35 = llvm.getelementptr %arg8[%31] : (!llvm.ptr<f16>, i64) -> !llvm.ptr<f16>
      llvm.store %34, %35 : !llvm.ptr<f16>
      llvm.br ^bb2
    ^bb2:  // 2 preds: ^bb0, ^bb1
      llvm.return
    }
