...
// CHECK-LABEL: .visible .entry Unknown99
module attributes {byre.container_module, gpu.container_module} {
  gpu.module @unified {
    ...
    ^bb1:  // pred: ^bb0
      ...
      %35 = llvm.getelementptr %arg8[%31] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
    ...
    ^bb1:  // pred: ^bb0
      ...
      %57 = llvm.select %52, %56, %55 : i1, i64
      %58 = llvm.srem %57, %27  : i64
      %59 = llvm.icmp "slt" %58, %24 : i64
      %60 = llvm.add %58, %27  : i64
      %61 = llvm.select %59, %60, %58 : i1, i64
      %62 = llvm.icmp "slt" %57, %24 : i64
      %63 = llvm.sub %28, %57  : i64
      %64 = llvm.select %62, %63, %57 : i1, i64
      %65 = llvm.sdiv %64, %27  : i64
      %66 = llvm.sub %28, %65  : i64
      %67 = llvm.select %62, %66, %65 : i1, i64
