...
constexpr StringRef getScopeTilingAnchorAttrName() { return "__byteir_scope_tile_anchor__"; }

// TODO change the following to a struct attr
constexpr StringRef getScopeTilingAxisAttrName() { return "__byteir_scope_tile_axis__"; }

constexpr StringRef getScopeTilingRankAttrName() { return "__byteir_scope_tile_rank__"; }
...
std::unique_ptr<OperationPass<FuncOp>> createLinalgScopeTilingPass(
  ...
  mlir::LinalgScopeTilingLoopType loopType = mlir::LinalgScopeTilingLoopType::SCFLoops,
