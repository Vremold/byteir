...
public:
  ...
  virtual mlir::LogicalResult emitAttribute(mlir::Location loc, mlir::Attribute attr);

  /// Emits operation 'op' with/without training semicolon or returns failure.
  virtual mlir::LogicalResult emitOperation(mlir::Operation& op, bool trailingSemicolon);
  ...
  virtual mlir::LogicalResult emitTypes(mlir::Location loc, mlir::ArrayRef<mlir::Type> types);

  /// Emits array of types as a std::tuple of the emitted types independently of
  /// the array size.
  virtual mlir::LogicalResult emitTupleType(mlir::Location loc, mlir::ArrayRef<mlir::Type> types);
  ...
  virtual mlir::LogicalResult emitOperandsAndAttributes(mlir::Operation& op,
