...
// a local popluate
void populateAffineLoadStoreConversionPatterns(
...
struct RewriteAffineToMemrefPass : public RewriteAffineToMemrefBase<RewriteAffineToMemrefPass> {
public:
...
void RewriteAffineToMemrefPass::runOnFunction() {
