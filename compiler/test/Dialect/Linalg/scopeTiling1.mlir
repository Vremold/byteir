...
func.func @matmul_element_static(%arg0: memref<128x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<128x64xf32>, %arg3: memref<128x64xf32>, %arg4: memref<128x64xf32>) {
  ...
  linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = ["parallel", "parallel"]} ins(%arg2, %arg3 : memref<128x64xf32>, memref<128x64xf32>) outs(%1 : memref<128x64xf32>) {
  ^bb0(%arg5: f32, %arg6: f32, %arg7: f32):  // no predecessors
    %3 = arith.addf %arg5, %arg6 : f32
    %4 = arith.mulf %3, %arg7 : f32
    linalg.yield %4 : f32
  }
  linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = ["parallel", "parallel"]} ins(%0, %1 : memref<128x64xf32>, memref<128x64xf32>) outs(%arg4 : memref<128x64xf32>) {
  ^bb0(%arg5: f32, %arg6: f32, %arg7: f32):  // no predecessors
    %3 = arith.addf %arg5, %arg6 : f32
    %4 = arith.mulf %3, %arg7 : f32
    linalg.yield %4 : f32
